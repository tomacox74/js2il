...
- tests/test262: port 40 additional collection and iteration execution cases across `Map`, `Set`, `WeakMap`, `WeakSet`, iterator objects, and `for-in`/`for-of` statements while preserving upstream paths and scenario names.
