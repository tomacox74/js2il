...
- tests/docs/test262: port 40 additional class/inheritance `test262` cases across declaration/expression computed elements, class-definition early errors, constructor/prototype metadata, and heritage validation; refresh the linked ECMA-262 support notes for class definitions and inheritance evidence.
