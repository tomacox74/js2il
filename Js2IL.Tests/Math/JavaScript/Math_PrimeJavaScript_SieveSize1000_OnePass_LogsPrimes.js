...
NOTE: This is a modified copy of tests\performance\PrimeJavaScript.js used for
correctness/output testing (sieveSize=1000, single pass, logs primes).
...
const main = ({ sieveSize, timeLimitSeconds, verbose, runtime }) =>
{
	...
	console.log(`prime-sieve;size=${sieveSize};count=${sieve.countPrimes()};valid=${validResult}`);

	// For correctness testing, log all found primes under the limit.
	const primes = sieve.getPrimes(sieve.sieveSizeInBits);
