...
namespace Js2IL.Tests.Variable
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact] public Task Variable_Destructuring_NullOrUndefined_ThrowsNodeMessage() { var testName = nameof(Variable_Destructuring_NullOrUndefined_ThrowsNodeMessage); return GenerateTest(testName); }
    }
}
