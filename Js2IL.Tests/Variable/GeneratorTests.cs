...
namespace Js2IL.Tests.Variable
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact] public Task Variable_ConstReassignmentError() { var testName = nameof(Variable_ConstReassignmentError); return GenerateTest(testName, assertOnIRPipelineFailure: true); }
