...
namespace Js2IL.Tests.Classes
{
    ...
    // Pseudo-private underscore fields are public in JS; prefer true private (#) tests only
        ...
        [Fact(Skip = "ECMAScript private fields (#) not yet supported")] public Task Classes_ClassPrivateField_HelperMethod_Log() { var testName = nameof(Classes_ClassPrivateField_HelperMethod_Log); return ExecutionTest(testName); }
    }
}
