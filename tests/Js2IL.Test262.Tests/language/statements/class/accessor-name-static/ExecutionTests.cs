...
namespace Js2IL.Test262.Tests.language.statements.class_.accessor_name_static;

public class ExecutionTests : DiskExecutionTestsBase
{
    public ExecutionTests() : base("language.statements.class_.accessor_name_static") { }
