...
namespace Js2IL.Test262.Tests.language.expressions.class_.accessor_name_static;

public class ExecutionTests : DiskExecutionTestsBase
{
    public ExecutionTests() : base("language.expressions.class_.accessor_name_static") { }
