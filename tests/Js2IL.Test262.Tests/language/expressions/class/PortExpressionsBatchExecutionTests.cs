...
public class PortExpressionsBatchExecutionTests : DiskExecutionTestsBase
{
    ...
    [Fact(DisplayName = "scope-meth-paramsbody-var-close", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_meth_paramsbody_var_close()
        => ExecutionTest("scope-meth-paramsbody-var-close");

    [Fact(DisplayName = "scope-meth-paramsbody-var-open", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_meth_paramsbody_var_open()
        => ExecutionTest("scope-meth-paramsbody-var-open");

    [Fact(DisplayName = "scope-name-lex-close", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_name_lex_close()
        => ExecutionTest("scope-name-lex-close");

    [Fact(DisplayName = "scope-name-lex-open-heritage", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_name_lex_open_heritage()
        => ExecutionTest("scope-name-lex-open-heritage");

    [Fact(DisplayName = "scope-name-lex-open-no-heritage", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_name_lex_open_no_heritage()
        => ExecutionTest("scope-name-lex-open-no-heritage");

    [Fact(DisplayName = "scope-setter-paramsbody-var-close", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_setter_paramsbody_var_close()
        => ExecutionTest("scope-setter-paramsbody-var-close");

    [Fact(DisplayName = "scope-setter-paramsbody-var-open", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_setter_paramsbody_var_open()
        => ExecutionTest("scope-setter-paramsbody-var-open");

    [Fact(DisplayName = "scope-static-meth-paramsbody-var-close", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
    public Task scope_static_meth_paramsbody_var_close()
        => ExecutionTest("scope-static-meth-paramsbody-var-close");

    [Fact(DisplayName = "scope-static-meth-paramsbody-var-open", Skip = "Tracked by #1093: current runtime behavior does not yet pass this upstream expression test.")]
