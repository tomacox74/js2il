...
public class ExecutionTests : ExecutionTestsBase
{
    ...
    [Fact(DisplayName = "absolute-value", Skip = "Known JS2IL defect")]
    public Task absolute_value()
        => ExecutionTest("absolute-value");

    [Fact(DisplayName = "S15.8.2.1_A1", Skip = "Known JS2IL defect")]
    public Task S15_8_2_1_A1()
        => ExecutionTest("S15.8.2.1_A1");

    [Fact(DisplayName = "S15.8.2.1_A2", Skip = "Known JS2IL defect")]
    public Task S15_8_2_1_A2()
        => ExecutionTest("S15.8.2.1_A2");

    [Fact(DisplayName = "S15.8.2.1_A3", Skip = "Known JS2IL defect")]
