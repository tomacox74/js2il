    ...
    public abstract class GeneratorTestsBase
    {
        ...
        private (string Script, string? SourcePath) GetJavaScriptAndSourcePath(string testName, string callerSourceFilePath)
        {
            ...
            if (stream == null)
            {
                ...
                var match = (categorySpecific != null
                    ? names.FirstOrDefault(n => string.Equals(n, categorySpecific, StringComparison.OrdinalIgnoreCase))
                    : null)
        ...
        {
            const string ExpectedNamespace = "Jroc.Runtime";
