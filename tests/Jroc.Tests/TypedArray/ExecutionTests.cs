...
namespace Jroc.Tests.TypedArray
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact]
        public Task TypedArray_SignedAndClamped_ConversionSemantics() { var testName = nameof(TypedArray_SignedAndClamped_ConversionSemantics); return ExecutionTest(testName); }
        ...
        [Fact]
        public Task Int32Array_FirstZeroBitSearch() { var testName = nameof(Int32Array_FirstZeroBitSearch); return ExecutionTest(testName); }
