...
namespace Jroc.Tests.TryCatch
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact]
        public Task TryCatch_NewExpression_ErrorOptionsCause() { var testName = nameof(TryCatch_NewExpression_ErrorOptionsCause); return ExecutionTest(testName); }
