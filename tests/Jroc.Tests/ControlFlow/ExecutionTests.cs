...
namespace Jroc.Tests.ControlFlow
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact]
        public Task ControlFlow_ForLoop_VarClosureCapture() { var testName = nameof(ControlFlow_ForLoop_VarClosureCapture); return ExecutionTest(testName); }
        ...
        [Fact]
        public Task ControlFlow_ForOf_Array_SymbolIterator_SparseLiteral() { var testName = nameof(ControlFlow_ForOf_Array_SymbolIterator_SparseLiteral); return ExecutionTest(testName); }
