...
namespace Jroc.Tests.ControlFlow
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact]
        public Task ControlFlow_ForOf_Array_Entries_Sparse() { var testName = nameof(ControlFlow_ForOf_Array_Entries_Sparse); return GenerateTest(testName); }
        ...
        [Fact]
        public Task ControlFlow_ForOf_Array_SymbolIterator_SparseLiteral() { var testName = nameof(ControlFlow_ForOf_Array_SymbolIterator_SparseLiteral); return GenerateTest(testName); }
