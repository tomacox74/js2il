...
namespace Jroc.Tests.Generator
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact]
        public Task Generator_GeneratedFunctionObject_Semantics() { var testName = nameof(Generator_GeneratedFunctionObject_Semantics); return GenerateTest(testName); }
        ...
        [Fact]
        public Task Generator_ExplicitReceiverAbi() { var testName = nameof(Generator_ExplicitReceiverAbi); return GenerateTest(testName); }
