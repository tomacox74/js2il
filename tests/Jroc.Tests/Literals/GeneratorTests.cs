...
namespace Jroc.Tests.Literals
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact] public Task Literals_NullAndUndefined() { var testName = nameof(Literals_NullAndUndefined); return GenerateTest(testName); }
        ...
        [Fact] public Task NewExpression_Boolean_Sugar() { var testName = nameof(NewExpression_Boolean_Sugar); return GenerateTest(testName); }
        [Fact] public Task NewExpression_Number_Sugar() { var testName = nameof(NewExpression_Number_Sugar); return GenerateTest(testName); }
