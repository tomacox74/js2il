...
const source = path.join(os.tmpdir(), `jroc-fs-callback-append-${uniqueSuffix}.txt`);
const renamed = path.join(os.tmpdir(), `jroc-fs-callback-append-${uniqueSuffix}-renamed.txt`);
