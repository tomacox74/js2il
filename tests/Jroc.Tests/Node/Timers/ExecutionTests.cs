...
using Jroc.Tests.Node;

namespace Jroc.Tests.Node.Timers
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact]
        public Task Timeout_RefreshAfterClear_DoesNotReactivate() => ExecutionTest(nameof(Timeout_RefreshAfterClear_DoesNotReactivate));
        ...
        [Fact]
        public Task Timers_Callback_Function_Objects() => ExecutionTest(nameof(Timers_Callback_Function_Objects));
    }
}
