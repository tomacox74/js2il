...
logError("pbkdf2 iterations float", () => crypto.pbkdf2Sync("password", "salt", 1.5, 16, "sha256"));
logError("pbkdf2 iterations zero", () => crypto.pbkdf2Sync("password", "salt", 0, 16, "sha256"));
logError("pbkdf2 keylen float", () => crypto.pbkdf2Sync("password", "salt", 1, 8.5, "sha256"));
