...
namespace Jroc.Tests.BinaryOperator
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact]
        public Task BinaryOperator_TypedComparisonScheduler() { var testName = nameof(BinaryOperator_TypedComparisonScheduler); return GenerateTest(testName); }
        ...
        [Fact]
        public Task BinaryOperator_NumericCoercionDoesNotRefineBinding() { var testName = nameof(BinaryOperator_NumericCoercionDoesNotRefineBinding); return GenerateTest(testName); }

        [Fact]
        public Task BinaryOperator_AddObjectObject() { var testName = nameof(BinaryOperator_AddObjectObject); return GenerateTest(testName); }
        ...
        [Fact]
        public Task BinaryOperator_BigInt_Operators() { var testName = nameof(BinaryOperator_BigInt_Operators); return GenerateTest(testName); }
        ...
        [Fact]
        public Task BinaryOperator_LogicalAnd_ShortCircuit() { var testName = nameof(BinaryOperator_LogicalAnd_ShortCircuit); return GenerateTest(testName); }
        ...
        [Fact]
        public Task BinaryOperator_LogicalOr_ShortCircuit() { var testName = nameof(BinaryOperator_LogicalOr_ShortCircuit); return GenerateTest(testName); }
        ...
        [Fact]
        public Task BinaryOperator_TypeofFunctionStrictEqual() { var testName = nameof(BinaryOperator_TypeofFunctionStrictEqual); return GenerateTest(testName); }

        [Fact]
        public Task BinaryOperator_TypeofFunctionStrictEqual_CallableShapes() { var testName = nameof(BinaryOperator_TypeofFunctionStrictEqual_CallableShapes); return GenerateTest(testName); }
