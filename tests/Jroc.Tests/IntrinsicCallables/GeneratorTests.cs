...
namespace Jroc.Tests.IntrinsicCallables
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        {
            return GenerateTest(nameof(IntrinsicCallables_RegExp_Literal_FreshAndConstructorIndependent));
        }
        ...
        {
            return GenerateTest(nameof(IntrinsicCallables_RegExp_Test_GuardedOverrides));
        }
