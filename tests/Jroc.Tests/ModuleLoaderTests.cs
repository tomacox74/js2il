...
public class ModuleLoaderTests
{
    ...
    public void LoadModules_ParseError_ReturnsNullAndLogsErrors()
    {
        ...
        var modulePath = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "jroc-tests", Guid.NewGuid().ToString("N"), "bad.js"));
    ...
    public void LoadModules_DependencyMissingUseStrict_LoadsSuccessfully()
    {
        ...
        var rootPath = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "jroc-tests", Guid.NewGuid().ToString("N"), "root.js"));
    ...
    public void LoadModules_StaticModuleSyntax_CreatesExplicitModuleRecordMetadata()
    {
        ...
        var rootPath = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "jroc-tests", Guid.NewGuid().ToString("N"), "root.mjs"));
...
""");
    ...
    public void LinkModules_CyclicGraph_TracksLinkAndEvaluationPhases()
    {
        ...
        var rootPath = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "jroc-tests", Guid.NewGuid().ToString("N"), "main.mjs"));
