...
namespace Jroc.Tests.ArrowFunction
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact]
        public Task ArrowFunction_LexicalThis_TopLevelCallback() { var testName = nameof(ArrowFunction_LexicalThis_TopLevelCallback); return ExecutionTest(testName); }
        ...
        [Fact]
        public Task ArrowFunction_LexicalSuper_MethodAndConstructor() { var testName = nameof(ArrowFunction_LexicalSuper_MethodAndConstructor); return ExecutionTest(testName); }

        [Fact]
        public Task ArrowFunction_GeneratedFunctionObjectSurface() { var testName = nameof(ArrowFunction_GeneratedFunctionObjectSurface); return ExecutionTest(testName); }
        ...
        [Fact]
        public Task ArrowFunction_ForLetBodyBlockClosure() { var testName = nameof(ArrowFunction_ForLetBodyBlockClosure); return ExecutionTest(testName); }

        [Fact]
        public Task ArrowFunction_ForOfIterableArrowCallback() { var testName = nameof(ArrowFunction_ForOfIterableArrowCallback); return ExecutionTest(testName); }
