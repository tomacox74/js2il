...
namespace Jroc.Tests.Classes
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact] public Task Classes_ClassConstructor_TypedNestedNew_FieldStore() { var testName = nameof(Classes_ClassConstructor_TypedNestedNew_FieldStore); return GenerateTest(testName); }
        ...
        [Fact] public Task Classes_ClassLocal_ReassignedClass_FallsBack() { var testName = nameof(Classes_ClassLocal_ReassignedClass_FallsBack); return GenerateTest(testName); }
        ...
        [Fact] public Task Classes_GeneratedMethodFunctionObjects() { var testName = nameof(Classes_GeneratedMethodFunctionObjects); return GenerateTest(testName); }
        [Fact] public Task Classes_GeneratedConstructorFunctionObjects() { var testName = nameof(Classes_GeneratedConstructorFunctionObjects); return GenerateTest(testName); }
