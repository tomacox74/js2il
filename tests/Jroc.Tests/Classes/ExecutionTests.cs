...
namespace Jroc.Tests.Classes
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact] public Task Classes_ClassConstructor_TypedNestedNew_FieldStore() { var testName = nameof(Classes_ClassConstructor_TypedNestedNew_FieldStore); return ExecutionTest(testName); }
        ...
        [Fact] public Task Classes_GeneratedMethodFunctionObjects() { var testName = nameof(Classes_GeneratedMethodFunctionObjects); return ExecutionTest(testName); }
        [Fact] public Task Classes_GeneratedConstructorFunctionObjects() { var testName = nameof(Classes_GeneratedConstructorFunctionObjects); return ExecutionTest(testName); }
        ...
        [Fact] public Task Classes_StaticMethod_Reassignment() { var testName = nameof(Classes_StaticMethod_Reassignment); return ExecutionTest(testName); }
        ...
        [Fact] public Task Classes_Inheritance_ExtendsExpression_StaticInheritance() { var testName = nameof(Classes_Inheritance_ExtendsExpression_StaticInheritance); return ExecutionTest(testName); }

        // #505: derived class extending intrinsic Array must compile and run, and super(...) must initialize length/elements.
        [Fact] public Task Classes_IntrinsicInheritance_ExtendsArray_SuperLength() { var testName = nameof(Classes_IntrinsicInheritance_ExtendsArray_SuperLength); return ExecutionTest(testName); }
