...
namespace Jroc.Tests.Array
{
    public class ExecutionTests : ExecutionTestsBase
    {
        ...
        [Fact]
        public Task Array_ObjectDispatch_Reflection() { var testName = nameof(Array_ObjectDispatch_Reflection); return ExecutionTest(testName); }

        [Fact]
        public Task Array_Exotic_Property_Descriptors() { var testName = nameof(Array_Exotic_Property_Descriptors); return ExecutionTest(testName); }

        [Fact]
        public Task Array_Exotic_Sloppy_Assignment() { var testName = nameof(Array_Exotic_Sloppy_Assignment); return ExecutionTest(testName); }
        ...
        [Fact]
        public Task Array_ExplicitReceiverAbi() { var testName = nameof(Array_ExplicitReceiverAbi); return ExecutionTest(testName); }
    }
}
