...
public class PortablePdbSequencePointTests
{
    ...
    {
        var outputPath = Path.Combine(Path.GetTempPath(), "Jroc.Tests", "PortablePdbSequencePoints", Guid.NewGuid().ToString("N"));
    ...
    {
        var outputPath = Path.Combine(Path.GetTempPath(), "Jroc.Tests", "PortablePdbDocumentMetadata", Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(outputPath);
    ...
    {
        var outputPath = Path.Combine(Path.GetTempPath(), "Jroc.Tests", "PortablePdbModuleRewrite", Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(outputPath);
    ...
    {
        var outputPath = Path.Combine(Path.GetTempPath(), "Jroc.Tests", "PortablePdbNestedModuleRewrite", Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(outputPath);
    ...
    {
        var outputPath = Path.Combine(Path.GetTempPath(), "Jroc.Tests", "PortablePdbNestedBlockStatements", Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(outputPath);
