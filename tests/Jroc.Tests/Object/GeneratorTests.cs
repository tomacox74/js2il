...
namespace Jroc.Tests.Object
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact]
        public Task ObjectLiteral_InterproceduralInference_Parity() { var testName = nameof(ObjectLiteral_InterproceduralInference_Parity); return GenerateTest(testName); }

        [Fact]
        public Task ObjectLiteral_DestructuredParameterInference_Parity() { var testName = nameof(ObjectLiteral_DestructuredParameterInference_Parity); return GenerateTest(testName); }
        ...
        [Fact]
        public Task Object_DynamicInlineCache_Invalidation() { var testName = nameof(Object_DynamicInlineCache_Invalidation); return GenerateTest(testName); }
        ...
        [Fact]
        public Task Object_DefineProperty_AccessorTransitions_And_Invariants() { var testName = nameof(Object_DefineProperty_AccessorTransitions_And_Invariants); return GenerateTest(testName); }

        [Fact]
        public Task Object_DefineProperty_NonExtensible_ReconfigureExisting() { var testName = nameof(Object_DefineProperty_NonExtensible_ReconfigureExisting); return GenerateTest(testName); }
        ...
        [Fact]
        public Task Object_SymbolKey_Descriptors_And_Enumeration() { var testName = nameof(Object_SymbolKey_Descriptors_And_Enumeration); return GenerateTest(testName); }
        ...
        [Fact]
        public Task Object_Integrity_DefineProperty_And_StrictWrites() { var testName = nameof(Object_Integrity_DefineProperty_And_StrictWrites); return GenerateTest(testName); }

        [Fact]
        public Task Object_OwnPropertyKeyOrdering() { var testName = nameof(Object_OwnPropertyKeyOrdering); return GenerateTest(testName); }
