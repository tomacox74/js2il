...
public class GeneratedContractTests
{
    ...
    public void GeneratedContracts_Enable_LoadModule_NoArgs_And_InvokeMembers()
    {
        ...
        var loadNoArgs = typeof(Jroc.Runtime.JsEngine)
            ...
            .Single(m => m.Name == nameof(Jroc.Runtime.JsEngine.LoadModule)
    ...
    {
        var outputDir = Path.Combine(Path.GetTempPath(), "Jroc.Tests", "GeneratedContracts", Guid.NewGuid().ToString("N"));
