...
namespace Js2IL.Tests.Function
{
    public class GeneratorTests : GeneratorTestsBase
    {
        ...
        [Fact]
        public Task Function_Arguments_Callee_Descriptor_NonStrict() { var testName = nameof(Function_Arguments_Callee_Descriptor_NonStrict); return GenerateTest(testName); }
