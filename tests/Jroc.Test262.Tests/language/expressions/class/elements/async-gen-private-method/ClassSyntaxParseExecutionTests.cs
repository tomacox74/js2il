...
namespace Jroc.Test262.Tests.language.expressions.class_.elements.async_gen_private_method;

public class ClassSyntaxParseExecutionTests : FileSystemExecutionTestsBase
{
    public ClassSyntaxParseExecutionTests() : base("language/expressions/class/elements/async-gen-private-method", "language.expressions.class_.elements.async_gen_private_method") { }
