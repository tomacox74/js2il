...
namespace Jroc.Test262.Tests.language.expressions.class_.elements.private_accessor_name;

public class ExecutionTests : ExecutionTestsBase
{
    public ExecutionTests() : base("language.expressions.class_.elements.private-accessor-name") { }
