...
{
    public ClassSyntaxParseExecutionTests() : base("language/expressions/class/elements/async-private-method", "language.expressions.class_.elements.async_private_method") { }
