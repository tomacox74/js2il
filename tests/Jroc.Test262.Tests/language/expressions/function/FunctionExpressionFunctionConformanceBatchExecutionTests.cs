...
public class FunctionExpressionFunctionConformanceBatchExecutionTests : FileSystemExecutionTestsBase
{
    public FunctionExpressionFunctionConformanceBatchExecutionTests() : base("language/expressions/function", "language.expressions.function") { }
    ...
    [Fact(DisplayName = "func-expr-strict-forbidden-ext-direct-access-prop-arguments.js")]
    public Task forbidden_ext_b1_func_expr_strict_forbidden_ext_direct_access_prop_arguments()
        => ExecutionTest("forbidden-ext/b1/func-expr-strict-forbidden-ext-direct-access-prop-arguments");

    [Fact(DisplayName = "func-expr-strict-forbidden-ext-direct-access-prop-caller.js")]
    public Task forbidden_ext_b1_func_expr_strict_forbidden_ext_direct_access_prop_caller()
        => ExecutionTest("forbidden-ext/b1/func-expr-strict-forbidden-ext-direct-access-prop-caller");

    [Fact(DisplayName = "func-expr-forbidden-ext-indirect-access-own-prop-caller-get.js")]
    public Task forbidden_ext_b2_func_expr_forbidden_ext_indirect_access_own_prop_caller_get()
        => ExecutionTest("forbidden-ext/b2/func-expr-forbidden-ext-indirect-access-own-prop-caller-get");

    [Fact(DisplayName = "func-expr-forbidden-ext-indirect-access-own-prop-caller-value.js")]
    public Task forbidden_ext_b2_func_expr_forbidden_ext_indirect_access_own_prop_caller_value()
        => ExecutionTest("forbidden-ext/b2/func-expr-forbidden-ext-indirect-access-own-prop-caller-value");

    [Fact(DisplayName = "func-expr-forbidden-ext-indirect-access-prop-caller.js")]
    public Task forbidden_ext_b2_func_expr_forbidden_ext_indirect_access_prop_caller()
        => ExecutionTest("forbidden-ext/b2/func-expr-forbidden-ext-indirect-access-prop-caller");
