...
public class ExecutionTests : ExecutionTestsBase
{
    ...
    [Fact(DisplayName = "S12.6.4_A3.1", Skip = "eval is not supported by JROC.")]
    public Task S12_6_4_A3_1()
        => ExecutionTest("S12.6.4_A3.1");

    [Fact(DisplayName = "S12.6.4_A3", Skip = "eval is not supported by JROC.")]
    public Task S12_6_4_A3()
        => ExecutionTest("S12.6.4_A3");

    [Fact(DisplayName = "S12.6.4_A4.1", Skip = "eval is not supported by JROC.")]
    public Task S12_6_4_A4_1()
        => ExecutionTest("S12.6.4_A4.1");

    [Fact(DisplayName = "S12.6.4_A4", Skip = "eval is not supported by JROC.")]
    ...
    [Fact(DisplayName = "cptn-decl-abrupt-empty", Skip = "eval is not supported by JROC.")]
    public Task cptn_decl_abrupt_empty()
        => ExecutionTest("cptn-decl-abrupt-empty");

    [Fact(DisplayName = "cptn-decl-itr", Skip = "eval is not supported by JROC.")]
    public Task cptn_decl_itr()
        => ExecutionTest("cptn-decl-itr");

    [Fact(DisplayName = "cptn-decl-skip-itr", Skip = "eval is not supported by JROC.")]
