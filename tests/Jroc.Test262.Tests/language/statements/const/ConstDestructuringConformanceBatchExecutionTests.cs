...
namespace Jroc.Test262.Tests.language.statements.const_;

public class ConstDestructuringConformanceBatchExecutionTests : FileSystemExecutionTestsBase
{
    public ConstDestructuringConformanceBatchExecutionTests()
        : base("language/statements/const", "language.statements.const_") { }
