...
public class ExecutionTests : ExecutionTestsBase
{
    ...
    [Fact(DisplayName = "cptn-value", Skip = "Uses eval, which JROC does not support yet.")]
    ...
    public Task dstr_ary_init_iter_get_err_array_prototype()
        => ExecutionTest(@"dstr\ary-init-iter-get-err-array-prototype", preferOutOfProc: true);
