...
public class LetDestructuringConformanceBatchExecutionTests : FileSystemExecutionTestsBase
{
    public LetDestructuringConformanceBatchExecutionTests()
        : base("language/statements/let", "language.statements.let_") { }

    [Fact(DisplayName = "ary-init-iter-close.js")]
    public Task test_ary_init_iter_close()
        => ExecutionTest("dstr/ary-init-iter-close");

    [Fact(DisplayName = "ary-init-iter-get-err-array-prototype.js")]
    public Task test_ary_init_iter_get_err_array_prototype()
    ...
    public Task test_ary_ptrn_elem_ary_rest_iter()
    ...
    public Task test_obj_init_null()
    ...
    public Task test_obj_ptrn_id_init_throws()
    ...
    public Task test_obj_ptrn_list_err()
    ...
    public Task test_obj_ptrn_prop_id_init_throws()
