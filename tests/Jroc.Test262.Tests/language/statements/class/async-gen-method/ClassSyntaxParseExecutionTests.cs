...
namespace Jroc.Test262.Tests.language.statements.class_.async_gen_method;

public class ClassSyntaxParseExecutionTests : FileSystemExecutionTestsBase
{
    public ClassSyntaxParseExecutionTests() : base("language/statements/class/async-gen-method", "language.statements.class_.async_gen_method") { }
