...
namespace Jroc.Test262.Tests.language.statements.class_.async_method;

public class ClassSyntaxParseExecutionTests : FileSystemExecutionTestsBase
{
    public ClassSyntaxParseExecutionTests() : base("language/statements/class/async-method", "language.statements.class_.async_method") { }
