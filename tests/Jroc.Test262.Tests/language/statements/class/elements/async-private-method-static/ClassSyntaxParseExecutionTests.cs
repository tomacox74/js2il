...
namespace Jroc.Test262.Tests.language.statements.class_.elements.async_private_method_static;

public class ClassSyntaxParseExecutionTests : FileSystemExecutionTestsBase
{
    public ClassSyntaxParseExecutionTests() : base("language/statements/class/elements/async-private-method-static", "language.statements.class_.elements.async_private_method_static") { }
