...
{
    public ClassSyntaxParseExecutionTests() : base("language/statements/class/elements", "language.statements.class_.elements") { }
    ...
    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-1")]
    public Task privatename_not_valid_earlyerr_script_1()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-1", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-2")]
    public Task privatename_not_valid_earlyerr_script_2()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-2", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-3")]
    public Task privatename_not_valid_earlyerr_script_3()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-3", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-4")]
    public Task privatename_not_valid_earlyerr_script_4()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-4", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-5")]
    public Task privatename_not_valid_earlyerr_script_5()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-5", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-6")]
    public Task privatename_not_valid_earlyerr_script_6()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-6", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-7")]
    public Task privatename_not_valid_earlyerr_script_7()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-7", "Failed to parse JavaScript");

    [Fact(DisplayName = "privatename-not-valid-earlyerr-script-8")]
    public Task privatename_not_valid_earlyerr_script_8()
        => CompilationFailureTest("privatename-not-valid-earlyerr-script-8", "Failed to parse JavaScript");
