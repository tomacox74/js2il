...
namespace Jroc.Test262.Tests.language.statements.class_.elements.syntax.early_errors.delete;

public class ClassSyntaxParseExecutionTests : FileSystemExecutionTestsBase
{
    public ClassSyntaxParseExecutionTests() : base("language/statements/class/elements/syntax/early-errors/delete", "language.statements.class_.elements.syntax.early_errors.delete") { }
