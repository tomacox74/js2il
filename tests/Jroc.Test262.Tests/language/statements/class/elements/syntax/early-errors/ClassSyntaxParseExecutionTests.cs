...
namespace Jroc.Test262.Tests.language.statements.class_.elements.syntax.early_errors;

public class ClassSyntaxParseExecutionTests : FileSystemExecutionTestsBase
{
    public ClassSyntaxParseExecutionTests() : base("language/statements/class/elements/syntax/early-errors", "language.statements.class_.elements.syntax.early_errors") { }
