...
public class PromiseBatchExecutionTests : InMemoryExecutionTestsBase
{
    public PromiseBatchExecutionTests() : base("built_ins.Promise.any") { }

    [Fact(DisplayName = "call-reject-element-after-return.js")]
    public Task call_reject_element_after_return()
        => ExecutionTestFromFile("call-reject-element-after-return");

    [Fact(DisplayName = "call-reject-element-items.js")]
    public Task call_reject_element_items()
        => ExecutionTestFromFile("call-reject-element-items");
    ...
    [Fact(DisplayName = "iter-arg-is-empty-iterable-reject.js")]
    public Task iter_arg_is_empty_iterable_reject()
        => ExecutionTestFromFile("iter-arg-is-empty-iterable-reject");
    ...
    [Fact(DisplayName = "reject-from-same-thenable.js")]
    public Task reject_from_same_thenable()
        => ExecutionTestFromFile("reject-from-same-thenable");

    [Fact(DisplayName = "reject-immed.js")]
    public Task reject_immed()
        => ExecutionTestFromFile("reject-immed");
    ...
    [Fact(DisplayName = "resolved-sequence.js")]
    public Task resolved_sequence()
        => ExecutionTestFromFile("resolved-sequence");

    [Fact(DisplayName = "returns-promise.js")]
    public Task returns_promise()
        => ExecutionTestFromFile("returns-promise");
