...
public class CatalogFailureBatchExecutionTests : DiskExecutionTestsBase
{
    ...
    [Fact(DisplayName = "iter-arg-is-poisoned.js")]
    public Task iter_arg_is_poisoned() => ExecutionTestFromFile("iter-arg-is-poisoned");
    ...
    [Fact(DisplayName = "iter-next-err-reject.js")]
    public Task iter_next_err_reject() => ExecutionTestFromFile("iter-next-err-reject");
