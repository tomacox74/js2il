...
namespace Jroc.Test262.Tests.built_ins.Date.prototype.setMilliseconds;

public partial class ExecutionTests
{
    [Fact(DisplayName = "arg-to-number-err.js")]
    public Task arg_to_number_err() => ExecutionTestFromFile("arg-to-number-err");
