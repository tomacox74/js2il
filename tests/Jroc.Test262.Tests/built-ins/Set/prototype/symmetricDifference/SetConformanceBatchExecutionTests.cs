...
{
    public SetConformanceBatchExecutionTests() : base("built_ins.Set.prototype.symmetricDifference") { }
    ...
    [Fact(DisplayName = "symmetricDifference.js")]
    public Task symmetricDifference() => ExecutionTestFromFile("symmetricDifference");
