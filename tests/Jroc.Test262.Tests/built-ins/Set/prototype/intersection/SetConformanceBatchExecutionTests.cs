...
{
    public SetConformanceBatchExecutionTests() : base("built_ins.Set.prototype.intersection") { }
    ...
    [Fact(DisplayName = "intersection.js")]
    public Task intersection() => ExecutionTestFromFile("intersection");
