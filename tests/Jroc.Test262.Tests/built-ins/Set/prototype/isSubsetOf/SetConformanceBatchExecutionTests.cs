...
{
    public SetConformanceBatchExecutionTests() : base("built_ins.Set.prototype.isSubsetOf") { }
    ...
    [Fact(DisplayName = "isSubsetOf.js")]
    public Task isSubsetOf() => ExecutionTestFromFile("isSubsetOf");
