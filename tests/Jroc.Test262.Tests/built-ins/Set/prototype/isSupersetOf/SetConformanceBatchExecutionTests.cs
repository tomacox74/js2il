...
namespace Jroc.Test262.Tests.built_ins.Set.prototype.isSupersetOf;

public class SetConformanceBatchExecutionTests : DiskExecutionTestsBase
{
    public SetConformanceBatchExecutionTests() : base("built_ins.Set.prototype.isSupersetOf") { }
    ...
    [Fact(DisplayName = "isSupersetOf.js")]
    public Task isSupersetOf() => ExecutionTestFromFile("isSupersetOf");
