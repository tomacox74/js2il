...
namespace Jroc.Test262.Tests.built_ins.TypedArray.prototype.buffer;

public class TypedArrayConformanceBatchExecutionTests : DiskExecutionTestsBase
{
    public TypedArrayConformanceBatchExecutionTests() : base("built_ins.TypedArray.prototype.buffer") { }
    ...
    [Fact(DisplayName = "this-inherits-typedarray.js")]
    public Task this_inherits_typedarray() => ExecutionTestFromFile("this-inherits-typedarray");
