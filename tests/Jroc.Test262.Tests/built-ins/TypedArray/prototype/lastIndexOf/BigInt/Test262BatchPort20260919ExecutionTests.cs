...
{
    public Test262BatchPort20260919ExecutionTests() : base("built_ins.TypedArray.prototype.lastIndexOf.BigInt") { }
    ...
    public Task tointeger_fromindex()
        => ExecutionTestFromFile("tointeger-fromindex");
