...
{
    public Test262BatchPort20260919ExecutionTests() : base("built_ins.TypedArray.prototype.lastIndexOf") { }
    ...
    [Fact(DisplayName = "negative-index-and-resize-to-smaller")]
    public Task negative_index_and_resize_to_smaller()
        => ExecutionTestFromFile("negative-index-and-resize-to-smaller");
