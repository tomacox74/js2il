...
public class TypedArrayFollowUpConformanceBatchExecutionTests : InMemoryExecutionTestsBase
{
    public TypedArrayFollowUpConformanceBatchExecutionTests() : base("built_ins.TypedArray.prototype.lastIndexOf") { }
