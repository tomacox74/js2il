...
namespace Jroc.Test262.Tests.built_ins.TypedArrayConstructors.prototype.@join;

public class IndexedMemoryConformance6BatchExecutionTests : DiskExecutionTestsBase
{
    public IndexedMemoryConformance6BatchExecutionTests() : base("built_ins.TypedArrayConstructors.prototype.join") { }
