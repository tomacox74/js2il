...
namespace Jroc.Test262.Tests.built_ins.TypedArrayConstructors.prototype.length;

public class IndexedMemoryConformance6BatchExecutionTests : DiskExecutionTestsBase
{
    public IndexedMemoryConformance6BatchExecutionTests() : base("built_ins.TypedArrayConstructors.prototype.length") { }
