...
namespace Jroc.Test262.Tests.built_ins.TypedArrayConstructors.Uint32Array;

public class TypedArrayConstructorsConformanceBatchExecutionTests : DiskExecutionTestsBase
{
    public TypedArrayConstructorsConformanceBatchExecutionTests() : base("built_ins.TypedArrayConstructors.Uint32Array") { }
