...
namespace Jroc.Test262.Tests.built_ins.TypedArrayConstructors.Int32Array.prototype;

public class TypedArrayConstructorsConformanceBatchExecutionTests : DiskExecutionTestsBase
{
    public TypedArrayConstructorsConformanceBatchExecutionTests() : base("built_ins.TypedArrayConstructors.Int32Array.prototype") { }
