...
{
    public TypedArrayConstructorsConformanceBatchExecutionTests() : base("built_ins.TypedArrayConstructors.ctors.buffer_arg") { }
    ...
    [Fact(DisplayName = "excessive-offset-throws-resizable-ab.js")]
    public Task excessive_offset_throws_resizable_ab() => ExecutionTestFromFile("excessive-offset-throws-resizable-ab");
