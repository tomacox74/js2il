...

{
    ...
    [Fact(DisplayName = "arguments-are-new-reg-exp-and-2-and-instance-is-string-hello")]
    public Task arguments_are_new_reg_exp_and_2_and_instance_is_string_hello()
        => ExecutionTestFromFile("arguments-are-new-reg-exp-and-2-and-instance-is-string-hello");

    [Fact(DisplayName = "arguments-are-new-reg-exp-and-3-and-instance-is-string-hello")]
    public Task arguments_are_new_reg_exp_and_3_and_instance_is_string_hello()
        => ExecutionTestFromFile("arguments-are-new-reg-exp-and-3-and-instance-is-string-hello");

    [Fact(DisplayName = "arguments-are-new-reg-exp-and-4-and-instance-is-string-hello")]
    public Task arguments_are_new_reg_exp_and_4_and_instance_is_string_hello()
        => ExecutionTestFromFile("arguments-are-new-reg-exp-and-4-and-instance-is-string-hello");

    [Fact(DisplayName = "arguments-are-new-reg-exp-and-hi-and-instance-is-string-hello")]
