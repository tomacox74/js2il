...
namespace Jroc.Test262.Tests.built_ins.Atomics.compareExchange.bigint;

public class AtomicsNative100ExecutionTests : InMemoryExecutionTestsBase
{
    public AtomicsNative100ExecutionTests() : base("built_ins.Atomics.compareExchange.bigint") { }
