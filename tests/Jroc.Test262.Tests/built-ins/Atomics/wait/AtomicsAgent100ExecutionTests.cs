...
{
    public AtomicsAgent100ExecutionTests() : base("built_ins.Atomics.wait") { }
    ...
    [Fact(DisplayName = "wait-index-value-not-equal.js")]
    public Task ported_wait_index_value_not_equal() => ExecutionTest("wait-index-value-not-equal");
