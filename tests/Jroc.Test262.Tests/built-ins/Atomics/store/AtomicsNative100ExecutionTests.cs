...
{
    public AtomicsNative100ExecutionTests() : base("built_ins.Atomics.store") { }
    ...
    [Fact(DisplayName = "expected-return-value-negative-zero.js")]
    public Task ported_expected_return_value_negative_zero() => ExecutionTestFromFile("expected-return-value-negative-zero");
