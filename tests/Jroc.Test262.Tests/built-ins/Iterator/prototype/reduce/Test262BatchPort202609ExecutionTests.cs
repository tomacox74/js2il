...
{
    public Test262BatchPort202609ExecutionTests() : base("built_ins.Iterator.prototype.reduce") { }
    ...
    [Fact(DisplayName = "reducer-throws-then-closing-iterator-also-throws")]
    public Task reducer_throws_then_closing_iterator_also_throws()
        => ExecutionTestFromFile("reducer-throws-then-closing-iterator-also-throws");

    [Fact(DisplayName = "reducer-throws")]
    public Task reducer_throws()
        => ExecutionTestFromFile("reducer-throws");
