...
{
    public Test262BatchPort202609ExecutionTests() : base("built_ins.Iterator.prototype.take") { }
    ...
    [Fact(DisplayName = "exhaustion-calls-return")]
    public Task exhaustion_calls_return()
        => ExecutionTestFromFile("exhaustion-calls-return");
    ...
    public Task limit_rangeerror()
        => ExecutionTestFromFile("limit-rangeerror");
    ...
    public Task return_is_forwarded()
        => ExecutionTestFromFile("return-is-forwarded");
