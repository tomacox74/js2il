...
{
    public Test262BatchPort202609ExecutionTests() : base("built_ins.Iterator.prototype.forEach") { }

    [Fact(DisplayName = "fn-throws-then-closing-iterator-also-throws")]
    public Task fn_throws_then_closing_iterator_also_throws()
        => ExecutionTestFromFile("fn-throws-then-closing-iterator-also-throws");

    [Fact(DisplayName = "fn-throws")]
    public Task fn_throws()
        => ExecutionTestFromFile("fn-throws");
