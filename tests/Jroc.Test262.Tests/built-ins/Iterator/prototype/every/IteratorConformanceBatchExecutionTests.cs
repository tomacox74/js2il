...
{
    public IteratorConformanceBatchExecutionTests() : base("built_ins.Iterator.prototype.every") { }
    ...
    [Fact(DisplayName = "predicate-returns-truthy-then-falsey.js")]
    public Task predicate_returns_truthy_then_falsey() => ExecutionTestFromFile("predicate-returns-truthy-then-falsey");
    ...
    [Fact(DisplayName = "result-is-boolean.js")]
    public Task result_is_boolean() => ExecutionTestFromFile("result-is-boolean");
