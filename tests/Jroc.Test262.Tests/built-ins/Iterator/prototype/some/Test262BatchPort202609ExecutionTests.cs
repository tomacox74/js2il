...
namespace Jroc.Test262.Tests.built_ins.Iterator.prototype.some;

public class Test262BatchPort202609ExecutionTests : InMemoryExecutionTestsBase
{
    public Test262BatchPort202609ExecutionTests() : base("built_ins.Iterator.prototype.some") { }
    ...
    public Task iterator_has_no_return()
        => ExecutionTestFromFile("iterator-has-no-return");
    ...
    public Task predicate_throws_then_closing_iterator_also_throws()
        => ExecutionTestFromFile("predicate-throws-then-closing-iterator-also-throws");

    [Fact(DisplayName = "predicate-throws")]
    public Task predicate_throws()
        => ExecutionTestFromFile("predicate-throws");
