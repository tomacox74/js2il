...
{
    public ExecutionTests() : base("built_ins.Iterator.zipKeyed") { }
    ...
    [Fact(DisplayName = "iterables-iteration-deleted.js")]
    public Task Ported_iterables_iteration_deleted() => ExecutionTestFromFile("iterables-iteration-deleted");

    [Fact(DisplayName = "iterables-iteration-enumerable.js")]
    public Task Ported_iterables_iteration_enumerable() => ExecutionTestFromFile("iterables-iteration-enumerable");

    [Fact(DisplayName = "iterables-iteration-get-abrupt-completion.js")]
    public Task Ported_iterables_iteration_get_abrupt_completion() => ExecutionTestFromFile("iterables-iteration-get-abrupt-completion");
    ...
    [Fact(DisplayName = "iterables-iteration-get-own-property-abrupt-completion.js")]
    public Task Ported_iterables_iteration_get_own_property_abrupt_completion() => ExecutionTestFromFile("iterables-iteration-get-own-property-abrupt-completion");

    [Fact(DisplayName = "iterables-iteration-inherited.js")]
    public Task Ported_iterables_iteration_inherited() => ExecutionTestFromFile("iterables-iteration-inherited");

    [Fact(DisplayName = "iterables-iteration-symbol-key.js")]
    public Task Ported_iterables_iteration_symbol_key() => ExecutionTestFromFile("iterables-iteration-symbol-key");

    [Fact(DisplayName = "iterables-iteration-undefined.js")]
    public Task Ported_iterables_iteration_undefined() => ExecutionTestFromFile("iterables-iteration-undefined");
    ...
    [Fact(DisplayName = "padding-iteration-get-abrupt-completion.js")]
    public Task Ported_padding_iteration_get_abrupt_completion() => ExecutionTestFromFile("padding-iteration-get-abrupt-completion");
    ...
    [Fact(DisplayName = "results-object-from-array.js")]
    public Task Ported_results_object_from_array() => ExecutionTestFromFile("results-object-from-array");

    [Fact(DisplayName = "results-object-has-default-attributes.js")]
    public Task Ported_results_object_has_default_attributes() => ExecutionTestFromFile("results-object-has-default-attributes");

    [Fact(DisplayName = "results-object-has-no-undefined-iterables-properties.js")]
    public Task Ported_results_object_has_no_undefined_iterables_properties() => ExecutionTestFromFile("results-object-has-no-undefined-iterables-properties");
