...
{
    public Test262BatchPort20260919ExecutionTests() : base("built_ins.Reflect.getOwnPropertyDescriptor") { }

    [Fact(DisplayName = "getOwnPropertyDescriptor")]
    public Task getOwnPropertyDescriptor()
        => ExecutionTestFromFile("getOwnPropertyDescriptor");
    ...
    [Fact(DisplayName = "undefined-property")]
    public Task undefined_property()
        => ExecutionTestFromFile("undefined-property");
