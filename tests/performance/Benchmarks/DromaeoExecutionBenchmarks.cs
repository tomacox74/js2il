...
/// </summary>
public class DromaeoExecutionBenchmarks : ExecutionBenchmarksBase
{
    ...
    private static string DromaeoScriptsDirectory => Path.Combine(
    ...
    {
        return BenchmarkScenarioCatalog.LoadScenarios(DromaeoScriptsDirectory)
    ...
    {
        var scenario = BenchmarkScenarioCatalog.LoadScenarios(DromaeoScriptsDirectory)
