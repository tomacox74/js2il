...
description: Port a specific upstream test262 case into tests/Jroc.Test262.Tests while preserving the original path/filename and adapting assert-based checks to this repo's execution-test model.
tier: standard
