...
| Constructor default parameters | Supported | `Js2IL.Tests/Classes/JavaScript/Classes_DefaultParameterValue_Constructor.js` | Class constructors support default parameter values. Call sites validate argument count against min/max parameter bounds and pad missing optional arguments with ldnull. Default values are applied using starg IL pattern when arguments are null. | 15.1.1 |
| Instance method default parameters | Supported | `Js2IL.Tests/Classes/JavaScript/Classes_DefaultParameterValue_Method.js` | Class instance methods support default parameter values. Methods are registered in ClassRegistry with min/max parameter counts. Call sites validate argument count ranges and pad missing optional parameters with ldnull before callvirt. | 15.1.1 |
