...
- **InternalsVisibleTo**: Added `InternalsVisibleTo` attribute to `Jroc.csproj` to expose internal classes (`Variables`, `Variable`, `VariableRegistry`) to the test project for comprehensive unit testing.
