# Changelog archive: v0.1.x

Browse-only archive for the `v0.1.x` release line. The active changelog remains [`CHANGELOG.md`](../../../CHANGELOG.md).

Covers `v0.1.7` through `v0.1.0-preview.3`.
...
- Tooling/docs: compiled scripts/ECMA262/generateFeatureCoverage.js with jroc and used the generated DLL to update docs.
...
Tooling
- Compiled scripts/ECMA262/generateFeatureCoverage.js with jroc; emitted generateFeatureCoverage.dll and runtimeconfig.json next to the script for faster local runs.
