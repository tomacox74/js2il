...
- **Track C (platform APIs):** [#790](https://github.com/tomacox74/js2il/issues/790), [#875](https://github.com/tomacox74/js2il/issues/875), and [#877](https://github.com/tomacox74/js2il/issues/877)
...
- `https`, `http`, `net`, and `stream` are tightly coupled; avoid starting a higher layer without the minimum lower-layer behavior it needs.
