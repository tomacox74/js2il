...
|---:|---|---|---|
| 11.1 | Source Text | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-source-text) |

## Subclauses

| Clause | Title | Status | Spec |
|---:|---|---|---|
| 11.1.1 | Static Semantics: UTF16EncodeCodePoint ( cp ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-utf16encodecodepoint) |
| 11.1.2 | Static Semantics: CodePointsToString ( text ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-codepointstostring) |
| 11.1.3 | Static Semantics: UTF16SurrogatePairToCodePoint ( lead , trail ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-utf16decodesurrogatepair) |
