...
JROC exposes many ECMAScript built-ins as CLR-backed delegates or intrinsic runtime constructors. That gives everyday built-in call/construct behavior for the implemented subset, but built-in function objects are not created through the full ECMA-262 realm/prototype/length/name machinery.
