...
> Last generated (UTC): 2026-04-20T16:16:16Z
...
### 19.3.33 ([tc39.es](https://tc39.es/ecma262/#sec-constructor-properties-of-the-global-object-syntaxerror))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Global SyntaxError constructor is available as a first-class value (e.g., assert.throws(SyntaxError, fn)) | Supported with Limitations | [`IntrinsicCallables_Eval_StrictSyntaxError_UsesGlobalSyntaxErrorValue.js`](../../../tests/Js2IL.Tests/IntrinsicCallables/JavaScript/IntrinsicCallables_Eval_StrictSyntaxError_UsesGlobalSyntaxErrorValue.js) |  | Exposes JavaScriptRuntime.GlobalThis.SyntaxError as a callable function value and links thrown SyntaxError instances through SyntaxError.prototype so constructor identity checks like `thrown.constructor === SyntaxError` succeed. js2il still does not implement general direct-eval execution; currently only direct string-literal eval syntax errors are surfaced as runtime SyntaxError values. |
