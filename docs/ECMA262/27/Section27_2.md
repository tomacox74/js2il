...
|---:|---|---|---|
| 27.2 | Promise Objects | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-promise-objects) |
...
| 27.2.5.5 | Promise.prototype [ %Symbol.toStringTag% ] | Supported | [tc39.es](https://tc39.es/ecma262/#sec-promise.prototype-%symbol.tostringtag%) |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Promise constructor (executor), Promise.resolve, Promise.reject | Supported | [`Promise_Executor_Resolved.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Executor_Resolved.js)<br>[`Promise_Executor_Rejected.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Executor_Rejected.js)<br>[`Promise_Thenable_Resolve_Immediate.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Thenable_Resolve_Immediate.js)<br>[`Promise_Thenable_Resolve_Delayed.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Thenable_Resolve_Delayed.js)<br>[`Promise_Thenable_Reject.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Thenable_Reject.js)<br>[`Promise_Thenable_NonFunctionThen.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Thenable_NonFunctionThen.js)<br>[`Promise_Thenable_Nested.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Thenable_Nested.js)<br>`tests/Jroc.Test262.Tests/built-ins/Promise/ExecutionTests.cs`<br>[`length.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/resolve/JavaScript/length.js)<br>[`name.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/resolve/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/resolve/JavaScript/prop-desc.js)<br>[`length.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/reject/JavaScript/length.js)<br>[`name.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/reject/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/reject/JavaScript/prop-desc.js)<br>`tests/Jroc.Test262.Tests/built-ins/Promise/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/Symbol.species/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/reject/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/resolve/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/try/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/withResolvers/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/prototype/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/prototype/then/NextBatch100ExecutionTests.cs` |  | Constructor accepts an executor delegate and supports resolving/rejecting, including thenable assimilation in Promise.resolve. Promise.reject is constructor-generic: it creates and validates a NewPromiseCapability from the receiver, invokes the captured rejection function with the supplied reason, and propagates abrupt completions. The checked-in test262 coverage also verifies static and resolving-function metadata. |

### 27.2.4.1 ([tc39.es](https://tc39.es/ecma262/#sec-promise.all))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Promise.all / allSettled / any / race | Supported | [`Promise_All_AllResolved.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_All_AllResolved.js)<br>[`Promise_All_OneRejected.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_All_OneRejected.js)<br>[`Promise_All_EmptyArray.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_All_EmptyArray.js)<br>[`Promise_AllSettled_MixedResults.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_AllSettled_MixedResults.js)<br>[`Promise_AllSettled_AllResolved.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_AllSettled_AllResolved.js)<br>[`Promise_AllSettled_AllRejected.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_AllSettled_AllRejected.js)<br>[`Promise_Any_FirstResolved.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Any_FirstResolved.js)<br>[`Promise_Any_AllRejected.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Any_AllRejected.js)<br>[`Promise_Race_FirstResolved.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Race_FirstResolved.js)<br>[`Promise_Race_FirstRejected.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Race_FirstRejected.js)<br>[`length.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/all/JavaScript/length.js)<br>[`name.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/all/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/all/JavaScript/prop-desc.js)<br>`tests/Jroc.Test262.Tests/built-ins/Promise/all/ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/all/FailingBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/all/CatalogFailureBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allKeyed/FailingBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allSettled/FailingBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allSettled/CatalogFailureBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allSettledKeyed/FailingBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/any/FailingBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/all/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allKeyed/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allSettled/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/allSettledKeyed/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/any/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/race/NextBatch100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Promise/race/CombinatorFailureExecutionTests.cs`<br>[`length.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/race/JavaScript/length.js)<br>[`name.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/race/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/race/JavaScript/prop-desc.js) |  | Promise.all, allSettled, any, race, allKeyed, and allSettledKeyed use the receiver constructor, create and validate promise capabilities, obtain the constructor's resolve method once, preserve input ordering where applicable, and apply iterator-close completion rules; per-element closures use an already-called guard where required. Promise.race remains pending for an empty iterable and now forwards each then call to the new promise capability, as verified by 42 previously failing native Test262 cases. Promise subclasses, including implicit derived constructors and rest-parameter constructors, construct through the Promise base constructor. Promise.any rejects with an AggregateError containing ordered rejection reasons. Cross-realm cases remain limited. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Promise.withResolvers() | Supported | [`Promise_WithResolvers_Resolve.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_WithResolvers_Resolve.js)<br>[`Promise_WithResolvers_Reject.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_WithResolvers_Reject.js)<br>[`Promise_WithResolvers_Idempotent.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_WithResolvers_Idempotent.js) |  |  |

### 27.2.4.10 ([tc39.es](https://tc39.es/ecma262/#sec-get-promise-%symbol.species%))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Promise[Symbol.species] | Supported | [`Promise_SymbolSpecies.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_SymbolSpecies.js) |  | Exposes Promise as a first-class global constructor value and defines a non-enumerable, configurable species accessor that returns the current constructor. |

### 27.2.5 ([tc39.es](https://tc39.es/ecma262/#sec-properties-of-the-promise-prototype-object))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Promise.prototype.then / catch / finally | Supported | [`Promise_Resolve_Then.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Resolve_Then.js)<br>[`Promise_Reject_Then.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Reject_Then.js)<br>[`Promise_Resolve_ThenFinally.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Resolve_ThenFinally.js)<br>[`Promise_Reject_FinallyCatch.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Reject_FinallyCatch.js)<br>[`Promise_Resolve_FinallyThen.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Resolve_FinallyThen.js)<br>[`Promise_Resolve_FinallyThrows.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Resolve_FinallyThrows.js)<br>[`Promise_Then_ReturnsResolvedPromise.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Then_ReturnsResolvedPromise.js)<br>[`Promise_Then_ReturnsRejectedPromise.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Then_ReturnsRejectedPromise.js)<br>[`Promise_Thenable_Returned_FromHandler.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Thenable_Returned_FromHandler.js)<br>[`Promise_Catch_ReturnsResolvedPromise.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Catch_ReturnsResolvedPromise.js)<br>[`Promise_Catch_ReturnsRejectedPromise.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Catch_ReturnsRejectedPromise.js)<br>[`Promise_Finally_ReturnsResolvedPromise.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Finally_ReturnsResolvedPromise.js)<br>[`Promise_Finally_ReturnsRejectedPromise.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Finally_ReturnsRejectedPromise.js)<br>[`Promise_Finally_ReturnsThenable_PassThrough_Fulfilled.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Finally_ReturnsThenable_PassThrough_Fulfilled.js)<br>[`Promise_Finally_ReturnsThenable_PassThrough_Rejected.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Finally_ReturnsThenable_PassThrough_Rejected.js)<br>[`Promise_Scheduling_StarvationTest.js`](../../../tests/Jroc.Tests/Promise/JavaScript/Promise_Scheduling_StarvationTest.js)<br>[`S25.4.5.1_A3.1_T1.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/S25.4.5.1_A3.1_T1.js)<br>[`S25.4.5.1_A3.1_T2.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/S25.4.5.1_A3.1_T2.js)<br>[`this-value-non-object.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/this-value-non-object.js)<br>[`invokes-then.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/invokes-then.js)<br>[`this-value-obj-coercible.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/this-value-obj-coercible.js)<br>[`this-value-then-poisoned.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/this-value-then-poisoned.js)<br>[`this-value-then-throws.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/this-value-then-throws.js)<br>[`is-a-method.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/is-a-method.js)<br>[`invokes-then-with-function.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/invokes-then-with-function.js)<br>[`invokes-then-with-non-function.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/invokes-then-with-non-function.js)<br>[`resolution-value-no-override.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/resolution-value-no-override.js)<br>[`rejection-reason-no-fulfill.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/rejection-reason-no-fulfill.js)<br>`tests/Jroc.Test262.Tests/built-ins/Promise/prototype/finally/FailingBatchExecutionTests.cs`<br>[`length.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/then/JavaScript/length.js)<br>[`name.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/then/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/then/JavaScript/prop-desc.js)<br>`tests/Jroc.Test262.Tests/built-ins/Promise/prototype/then/FailingBatchExecutionTests.cs` |  | Implements then/catch/finally with scheduling, constructor and species selection, and thenable assimilation for returned values. catch and finally generically delegate through the receiver's then property, preserve abrupt completions, handle callable and non-callable finally handlers, and preserve fulfillment values or rejection reasons. Host rejection tracking still has limitations. |

### 27.2.5.5 ([tc39.es](https://tc39.es/ecma262/#sec-promise.prototype-%symbol.tostringtag%))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Promise.prototype [ %Symbol.toStringTag% ] | Supported | [`Promise_prototype_Symbol_toStringTag.js`](../../../tests/Jroc.Test262.Tests/built-ins/Promise/prototype/JavaScript/Promise_prototype_Symbol_toStringTag.js) |  | The global Promise constructor now exposes a prototype object branded with Symbol.toStringTag as "Promise", and Promise instances inherit that brand. |
