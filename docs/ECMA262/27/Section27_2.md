...
|---|---|---|---|
| Promise constructor (executor), Promise.resolve, Promise.reject | Supported | [`Promise_Executor_Resolved.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Executor_Resolved.js)<br>[`Promise_Executor_Rejected.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Executor_Rejected.js)<br>[`Promise_Thenable_Resolve_Immediate.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Thenable_Resolve_Immediate.js)<br>[`Promise_Thenable_Resolve_Delayed.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Thenable_Resolve_Delayed.js)<br>[`Promise_Thenable_Reject.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Thenable_Reject.js)<br>[`Promise_Thenable_NonFunctionThen.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Thenable_NonFunctionThen.js)<br>[`Promise_Thenable_Nested.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Thenable_Nested.js)<br>`tests/Js2IL.Test262.Tests/built-ins/Promise/ExecutionTests.cs`<br>[`length.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/resolve/JavaScript/length.js)<br>[`name.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/resolve/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/resolve/JavaScript/prop-desc.js)<br>[`length.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/reject/JavaScript/length.js)<br>[`name.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/reject/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/reject/JavaScript/prop-desc.js) | Constructor accepts an executor delegate and supports resolving/rejecting, including thenable assimilation in Promise.resolve. The checked-in test262 coverage now also verifies Promise.resolve and Promise.reject name/length/property-descriptor metadata. |

### 27.2.4.1 ([tc39.es](https://tc39.es/ecma262/#sec-promise.all))

| Feature name | Status | Test scripts | Notes |
|---|---|---|---|
| Promise.all / allSettled / any / race | Supported | [`Promise_All_AllResolved.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_All_AllResolved.js)<br>[`Promise_All_OneRejected.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_All_OneRejected.js)<br>[`Promise_All_EmptyArray.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_All_EmptyArray.js)<br>[`Promise_AllSettled_MixedResults.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_AllSettled_MixedResults.js)<br>[`Promise_AllSettled_AllResolved.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_AllSettled_AllResolved.js)<br>[`Promise_AllSettled_AllRejected.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_AllSettled_AllRejected.js)<br>[`Promise_Any_FirstResolved.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Any_FirstResolved.js)<br>[`Promise_Any_AllRejected.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Any_AllRejected.js)<br>[`Promise_Race_FirstResolved.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Race_FirstResolved.js)<br>[`Promise_Race_FirstRejected.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Race_FirstRejected.js)<br>[`length.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/all/JavaScript/length.js)<br>[`name.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/all/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/all/JavaScript/prop-desc.js)<br>[`length.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/race/JavaScript/length.js)<br>[`name.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/race/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/race/JavaScript/prop-desc.js) |  |
...
| Feature name | Status | Test scripts | Notes |
|---|---|---|---|
| Promise.prototype.then / catch / finally | Supported | [`Promise_Resolve_Then.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Resolve_Then.js)<br>[`Promise_Reject_Then.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Reject_Then.js)<br>[`Promise_Resolve_ThenFinally.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Resolve_ThenFinally.js)<br>[`Promise_Reject_FinallyCatch.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Reject_FinallyCatch.js)<br>[`Promise_Resolve_FinallyThen.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Resolve_FinallyThen.js)<br>[`Promise_Resolve_FinallyThrows.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Resolve_FinallyThrows.js)<br>[`Promise_Then_ReturnsResolvedPromise.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Then_ReturnsResolvedPromise.js)<br>[`Promise_Then_ReturnsRejectedPromise.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Then_ReturnsRejectedPromise.js)<br>[`Promise_Thenable_Returned_FromHandler.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Thenable_Returned_FromHandler.js)<br>[`Promise_Catch_ReturnsResolvedPromise.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Catch_ReturnsResolvedPromise.js)<br>[`Promise_Catch_ReturnsRejectedPromise.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Catch_ReturnsRejectedPromise.js)<br>[`Promise_Finally_ReturnsResolvedPromise.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Finally_ReturnsResolvedPromise.js)<br>[`Promise_Finally_ReturnsRejectedPromise.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Finally_ReturnsRejectedPromise.js)<br>[`Promise_Finally_ReturnsThenable_PassThrough_Fulfilled.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Finally_ReturnsThenable_PassThrough_Fulfilled.js)<br>[`Promise_Finally_ReturnsThenable_PassThrough_Rejected.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Finally_ReturnsThenable_PassThrough_Rejected.js)<br>[`Promise_Scheduling_StarvationTest.js`](../../../tests/Js2IL.Tests/Promise/JavaScript/Promise_Scheduling_StarvationTest.js)<br>[`S25.4.5.1_A3.1_T1.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/S25.4.5.1_A3.1_T1.js)<br>[`S25.4.5.1_A3.1_T2.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/S25.4.5.1_A3.1_T2.js)<br>[`this-value-non-object.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/catch/JavaScript/this-value-non-object.js)<br>[`is-a-method.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/is-a-method.js)<br>[`resolution-value-no-override.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/resolution-value-no-override.js)<br>[`rejection-reason-no-fulfill.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/finally/JavaScript/rejection-reason-no-fulfill.js)<br>[`length.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/then/JavaScript/length.js)<br>[`name.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/then/JavaScript/name.js)<br>[`prop-desc.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/then/JavaScript/prop-desc.js) | Implements then/catch/finally with scheduling and thenable assimilation for returned values. Checked-in test262 coverage now includes Promise.prototype.catch/finally metadata, non-object receiver TypeError behavior, fulfilled/rejected pass-through via catch/finally, and the Promise.prototype.then length/name/property descriptor surface; host rejection tracking still has limitations. |
| Promise.prototype [ %Symbol.toStringTag% ] | Supported | [`Promise_prototype_Symbol_toStringTag.js`](../../../tests/Js2IL.Test262.Tests/built-ins/Promise/prototype/JavaScript/Promise_prototype_Symbol_toStringTag.js) | The global Promise constructor now exposes a prototype object branded with Symbol.toStringTag as "Promise", and Promise instances inherit that brand. |
