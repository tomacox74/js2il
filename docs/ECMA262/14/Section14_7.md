...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| do-while legacy control-flow ports | Supported | [`S12.6.1_A2.js`](../../../tests/Js2IL.Test262.Tests/language/statements/do-while/JavaScript/S12.6.1_A2.js)<br>[`S12.6.1_A9.js`](../../../tests/Js2IL.Test262.Tests/language/statements/do-while/JavaScript/S12.6.1_A9.js)<br>[`S12.6.1_A4_T5.js`](../../../tests/Js2IL.Test262.Tests/language/statements/do-while/JavaScript/S12.6.1_A4_T5.js) |  | The checked-in legacy slice covers do-while body execution, labeled break/continue flow, and ReferenceError propagation from do-while test expressions through surrounding catch handlers. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| while legacy control-flow ports | Supported | [`S12.6.2_A2.js`](../../../tests/Js2IL.Test262.Tests/language/statements/while/JavaScript/S12.6.2_A2.js)<br>[`S12.6.2_A4_T2.js`](../../../tests/Js2IL.Test262.Tests/language/statements/while/JavaScript/S12.6.2_A4_T2.js)<br>[`S12.6.2_A4_T3.js`](../../../tests/Js2IL.Test262.Tests/language/statements/while/JavaScript/S12.6.2_A4_T3.js)<br>[`S12.6.2_A4_T4.js`](../../../tests/Js2IL.Test262.Tests/language/statements/while/JavaScript/S12.6.2_A4_T4.js)<br>[`S12.6.2_A9.js`](../../../tests/Js2IL.Test262.Tests/language/statements/while/JavaScript/S12.6.2_A9.js)<br>[`S12.6.2_A4_T5.js`](../../../tests/Js2IL.Test262.Tests/language/statements/while/JavaScript/S12.6.2_A4_T5.js) |  | The checked-in legacy slice covers while body execution, nested break behavior with hoisted `var` declarations, and ReferenceError propagation from while test expressions through surrounding catch handlers. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| for-in over objects (enumerate enumerable keys) | Supported | [`ControlFlow_ForIn_Object_Basic.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_Object_Basic.js)<br>[`ControlFlow_ForIn_Continue.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_Continue.js)<br>[`ControlFlow_ForIn_Break.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_Break.js)<br>[`ControlFlow_ForIn_LabeledContinue.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_LabeledContinue.js)<br>[`ControlFlow_ForIn_LabeledBreak.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_LabeledBreak.js)<br>[`ControlFlow_ForIn_Mutation_DeleteAndAdd.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_Mutation_DeleteAndAdd.js)<br>[`ControlFlow_ForIn_ClassFields_BaseAndDerived.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_ClassFields_BaseAndDerived.js)<br>[`ControlFlow_ForIn_Shadowing_NoDuplicateKeys.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForIn_Shadowing_NoDuplicateKeys.js)<br>[`cptn-decl-itr.js`](../../../tests/Js2IL.Test262.Tests/language/statements/for-in/JavaScript/cptn-decl-itr.js)<br>[`cptn-decl-skip-itr.js`](../../../tests/Js2IL.Test262.Tests/language/statements/for-in/JavaScript/cptn-decl-skip-itr.js)<br>[`cptn-decl-abrupt-empty.js`](../../../tests/Js2IL.Test262.Tests/language/statements/for-in/JavaScript/cptn-decl-abrupt-empty.js) | `test/language/statements/for-in/cptn-decl-itr.js`<br>`test/language/statements/for-in/cptn-decl-skip-itr.js`<br>`test/language/statements/for-in/cptn-decl-abrupt-empty.js`<br>`test/language/statements/for-in/12.6.4-1.js`<br>`test/language/statements/for-in/12.6.4-2.js`<br>`test/language/statements/for-in/head-const-fresh-binding-per-iteration.js`<br>`test/language/statements/for-in/head-const-bound-names-fordecl-tdz.js`<br>`test/language/statements/for-in/head-decl-expr.js`<br>`test/language/statements/for-in/head-expr-expr.js`<br>`test/language/statements/for-in/head-let-bound-names-fordecl-tdz.js`<br>`test/language/statements/for-in/head-let-destructuring.js`<br>`test/language/statements/for-in/head-let-fresh-binding-per-iteration.js`<br>`test/language/statements/for-in/head-lhs-cover.js`<br>`test/language/statements/for-in/head-lhs-let.js`<br>`test/language/statements/for-in/S12.6.4_A1.js`<br>`test/language/statements/for-in/S12.6.4_A2.js`<br>`test/language/statements/for-in/S12.6.4_A5.js`<br>`test/language/statements/for-in/S12.6.4_A5.1.js`<br>`test/language/statements/for-in/S12.6.4_A6.js`<br>`test/language/statements/for-in/S12.6.4_A6.1.js`<br>`test/language/statements/for-in/S12.6.4_A7_T1.js`<br>`test/language/statements/for-in/S12.6.4_A7_T2.js`<br>`test/language/block-scope/syntax/for-in/acquire-properties-from-array.js` | Lowered via a native For-In Iterator (EnumerateObjectProperties/CreateForInIterator) and consumed through JavaScriptRuntime.Object.IteratorNext + IteratorResultDone/Value. Each next() step re-checks key presence so deletions during enumeration are respected, loop-head RHS evaluation observes let/const TDZ bindings in the loop lexical scope, and current bounded test262 coverage also exercises fresh per-iteration lexical bindings, destructuring heads, inherited array-index setters, and block-scoped array property acquisition. Prototype chain semantics are approximated for CLR objects by walking the CLR type hierarchy (declared public instance members per type); ExpandoObject/IDictionary do not currently expose a JS-observable [[Prototype]] chain. |
| for-of over arrays (enumerate values) | Supported | [`ControlFlow_ForOf_Array_Basic.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_Array_Basic.js)<br>[`ControlFlow_ForOf_Array_SymbolIterator_SparseLiteral.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_Array_SymbolIterator_SparseLiteral.js)<br>[`ControlFlow_ForOf_Continue.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_Continue.js)<br>[`ControlFlow_ForOf_Break.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_Break.js)<br>[`ControlFlow_ForOf_LabeledContinue.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_LabeledContinue.js)<br>[`ControlFlow_ForOf_LabeledBreak.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_LabeledBreak.js)<br>[`ControlFlow_ForOf_CustomIterable_IteratorProtocol.js`](../../../tests/Js2IL.Tests/ControlFlow/JavaScript/ControlFlow_ForOf_CustomIterable_IteratorProtocol.js)<br>[`arguments-mapped.js`](../../../tests/Js2IL.Test262.Tests/language/statements/for-of/JavaScript/arguments-mapped.js) | suite `pr`<br>suite `nightly`<br>`test/language/statements/for-of/Array.prototype.Symbol.iterator.js`<br>`test/language/statements/for-of/array-contract.js`<br>`test/language/statements/for-of/array-contract-expand.js`<br>`test/language/statements/for-of/array-expand-contract.js`<br>`test/language/statements/for-of/arguments-unmapped-aliasing.js`<br>`test/language/statements/for-of/Array.prototype.entries.js`<br>`test/language/statements/for-of/Array.prototype.keys.js`<br>`test/language/statements/for-of/array-expand.js`<br>`test/language/statements/for-of/array-key-get-error.js`<br>`test/language/statements/for-of/body-dstr-assign-error.js`<br>`test/language/statements/for-of/body-dstr-assign.js`<br>`test/language/statements/for-of/dstr/array-elem-init-assignment.js`<br>`test/language/statements/for-of/dstr/array-elem-init-in.js`<br>`test/language/statements/for-of/dstr/array-elem-init-let.js`<br>`test/language/statements/for-of/dstr/array-elem-init-order.js`<br>`test/language/statements/for-of/dstr/array-elem-iter-nrml-close-null.js`<br>`test/language/statements/for-of/dstr/array-elem-iter-nrml-close-skip.js`<br>`test/language/statements/for-of/dstr/array-elem-iter-nrml-close.js`<br>`test/language/statements/for-of/dstr/array-elem-iter-rtrn-close-null.js`<br>`test/language/statements/for-of/float32array-mutate.js`<br>`test/language/statements/for-of/float32array.js`<br>`test/language/statements/for-of/int16array-mutate.js`<br>`test/language/statements/for-of/int16array.js`<br>`test/language/statements/for-of/int8array.js`<br>`test/language/statements/for-of/generator.js`<br>`test/language/statements/for-of/arguments-mapped.js`<br>`test/language/statements/for-of/arguments-mapped-aliasing.js`<br>`test/language/statements/for-of/arguments-mapped-mutation.js`<br>`test/language/statements/for-of/arguments-unmapped.js`<br>`test/language/statements/for-of/arguments-unmapped-mutation.js`<br>`test/language/statements/for-of/array.js`<br>`test/language/statements/for-of/break.js`<br>`test/language/statements/for-of/break-label.js`<br>`test/language/statements/for-of/continue.js`<br>`test/language/statements/for-of/continue-label.js`<br>`test/language/statements/for-of/generator-close-via-break.js`<br>`test/language/statements/for-of/generator-close-via-continue.js`<br>`test/language/statements/for-of/generator-close-via-return.js`<br>`test/language/statements/for-of/generator-close-via-throw.js` | Lowered using the iterator protocol via JavaScriptRuntime.Object.GetIterator + iterator.next() + result.value/result.done, and invokes JavaScriptRuntime.Object.IteratorClose on normal destructuring completion and abrupt completion (break/continue/throw/return and iterator throws), including generator-safe synthetic close paths. Supports built-ins (Array/string/Int8Array/Int16Array/Int32Array/Float32Array/Float64Array), user-defined iterables via [Symbol.iterator], mapped and unmapped arguments objects, generator objects, and a best-effort fallback for .NET IEnumerable. Sparse array literals flow through the IR path as arrays whose elisions iterate as undefined values, so explicit array[Symbol.iterator](), destructuring, typed-array, generator, generator close-on-abrupt-completion, and arguments-object for-of cases in the bounded test262 coverage compile successfully. |
