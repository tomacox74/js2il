...
|---:|---|---|---|
| 14.15 | The try Statement | Partially Supported | [tc39.es](https://tc39.es/ecma262/#sec-try-statement) |

## Subclauses

| Clause | Title | Status | Spec |
|---:|---|---|---|
| 14.15.1 | Static Semantics: Early Errors | Partially Supported | [tc39.es](https://tc39.es/ecma262/#sec-try-statement-static-semantics-early-errors) |
...
| 14.15.3 | Runtime Semantics: Evaluation | Partially Supported | [tc39.es](https://tc39.es/ecma262/#sec-try-statement-runtime-semantics-evaluation) |
