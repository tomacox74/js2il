...
|---|---|---|---|
| Empty statement (;) | Supported | [`ControlFlow_EmptyStatement.js`](../../../tests/Jroc.Tests/ControlFlow/JavaScript/ControlFlow_EmptyStatement.js) | Parsed as an EmptyStatement node and lowered as a no-op; has no observable runtime effect. |
