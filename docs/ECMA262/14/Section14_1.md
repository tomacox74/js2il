...
|---:|---|---|---|
| 14.1 | Statement Semantics | Partially Supported | [tc39.es](https://tc39.es/ecma262/#sec-statement-semantics) |

## Subclauses

| Clause | Title | Status | Spec |
|---:|---|---|---|
| 14.1.1 | Runtime Semantics: Evaluation | Partially Supported | [tc39.es](https://tc39.es/ecma262/#sec-statement-semantics-runtime-semantics-evaluation) |
