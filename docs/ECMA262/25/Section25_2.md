...
> Last generated (UTC): 2026-07-25T20:46:20Z

JROC provides fixed-length SharedArrayBuffer instances backed by the existing ArrayBuffer storage implementation. Construction, typed-array views, byteLength, and basic slice behavior are available, but storage is not shared across agents and growable-buffer semantics are not implemented.
