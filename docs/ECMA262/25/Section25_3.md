...
| 25.3.4.5 | DataView.prototype.getBigInt64 ( byteOffset [ , littleEndian ] ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-dataview.prototype.getbigint64) |
| 25.3.4.6 | DataView.prototype.getBigUint64 ( byteOffset [ , littleEndian ] ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-dataview.prototype.getbiguint64) |
...
| 25.3.4.16 | DataView.prototype.setBigInt64 ( byteOffset , value [ , littleEndian ] ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-dataview.prototype.setbigint64) |
| 25.3.4.17 | DataView.prototype.setBigUint64 ( byteOffset , value [ , littleEndian ] ) | Supported with Limitations | [tc39.es](https://tc39.es/ecma262/#sec-dataview.prototype.setbiguint64) |
...
|---|---|---|---|---|
| DataView(buffer, byteOffset, byteLength) | Supported with Limitations | `tests/Jroc.Test262.Tests/built-ins/DataView/ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/DetachmentBatchExecutionTests.cs`<br>[`DataView_ByteOffset_ByteLength.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_ByteOffset_ByteLength.js)<br>[`DataView_BoundsChecks_RangeError.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_BoundsChecks_RangeError.js)<br>[`DataView_InvalidByteOffset_ByteLength_Messages.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_InvalidByteOffset_ByteLength_Messages.js) | `test/built-ins/DataView/newtarget-undefined-throws.js`<br>`test/built-ins/DataView/detached-buffer.js` | Supports a first-class DataView constructor plus fixed-length ArrayBuffer-backed views with byteOffset/byteLength validation, distinct RangeError diagnostics for invalid byteOffset versus byteLength, bounds checks, and rejection of detached buffers after observable argument coercions. SharedArrayBuffer, resizable buffers, and custom newTarget prototypes are not implemented. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| DataView numeric getters/setters | Supported with Limitations | [`DataView_SetGet_UintAndEndian.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_SetGet_UintAndEndian.js)<br>[`DataView_Float32_Float64_RoundTrip.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_Float32_Float64_RoundTrip.js)<br>`tests/Jroc.Test262.Tests/built-ins/DataView/PortNext200Batch2ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/getInt8/DetachmentBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/getInt8/IntrinsicSurfaceExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/getBigInt64/BigIntBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/getBigUint64/BigIntBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/setInt8/DetachmentBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/setInt8/IntrinsicSurfaceExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/setBigInt64/BigIntBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/setBigUint64/BigIntBatchExecutionTests.cs` | `test/built-ins/DataView/prototype/getFloat32/toindex-byteoffset.js`<br>`test/built-ins/DataView/prototype/getFloat64/toindex-byteoffset.js`<br>`test/built-ins/DataView/prototype/getInt16/toindex-byteoffset.js`<br>`test/built-ins/DataView/prototype/getInt8/detached-buffer.js`<br>`test/built-ins/DataView/prototype/getInt8/length.js`<br>`test/built-ins/DataView/prototype/getInt8/name.js`<br>`test/built-ins/DataView/prototype/getInt8/not-a-constructor.js`<br>`test/built-ins/DataView/prototype/getBigInt64/return-values.js`<br>`test/built-ins/DataView/prototype/getBigUint64/return-values.js`<br>`test/built-ins/DataView/prototype/setInt8/detached-buffer-after-number-value.js`<br>`test/built-ins/DataView/prototype/setInt8/index-check-before-value-conversion.js`<br>`test/built-ins/DataView/prototype/setInt8/length.js`<br>`test/built-ins/DataView/prototype/setInt8/name.js`<br>`test/built-ins/DataView/prototype/setInt8/not-a-constructor.js`<br>`test/built-ins/DataView/prototype/setBigInt64/set-values-return-undefined.js`<br>`test/built-ins/DataView/prototype/setBigUint64/this-is-not-object.js` | Implements get/set for BigInt64, BigUint64, Int8, Uint8, Int16, Uint16, Int32, Uint32, Float32, and Float64 with optional littleEndian support (default big-endian). Each operation is exposed as a receiver-aware, non-constructible prototype method with standard name, length, and property attributes. Byte offsets use ToIndex coercion, including truncation of negative fractional values before range validation. Numeric accessors reject detached backing buffers after required argument coercions, and setters validate the offset before converting the value. BigInt writes use modulo-2^64 conversion. Float16 and immutable ArrayBuffer write rejection remain unimplemented. |
| DataView prototype buffer accessors | Supported | `tests/Jroc.Test262.Tests/built-ins/DataView/prototype/ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/buffer/ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/buffer/DetachmentBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/byteLength/ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/byteLength/DetachmentBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/byteOffset/ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/byteOffset/DetachmentBatchExecutionTests.cs`<br>[`DataView_ByteOffset_ByteLength.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_ByteOffset_ByteLength.js) | `test/built-ins/DataView/prototype/Symbol.toStringTag.js`<br>`test/built-ins/DataView/prototype/buffer/invoked-as-accessor.js`<br>`test/built-ins/DataView/prototype/buffer/length.js`<br>`test/built-ins/DataView/prototype/buffer/name.js`<br>`test/built-ins/DataView/prototype/buffer/prop-desc.js`<br>`test/built-ins/DataView/prototype/buffer/return-buffer.js`<br>`test/built-ins/DataView/prototype/buffer/detached-buffer.js`<br>`test/built-ins/DataView/prototype/byteLength/invoked-as-accessor.js`<br>`test/built-ins/DataView/prototype/byteLength/length.js`<br>`test/built-ins/DataView/prototype/byteLength/name.js`<br>`test/built-ins/DataView/prototype/byteLength/prop-desc.js`<br>`test/built-ins/DataView/prototype/byteLength/detached-buffer.js`<br>`test/built-ins/DataView/prototype/byteLength/instance-has-detached-buffer.js`<br>`test/built-ins/DataView/prototype/byteOffset/invoked-as-accessor.js`<br>`test/built-ins/DataView/prototype/byteOffset/length.js`<br>`test/built-ins/DataView/prototype/byteOffset/name.js`<br>`test/built-ins/DataView/prototype/byteOffset/prop-desc.js`<br>`test/built-ins/DataView/prototype/byteOffset/detached-buffer.js` | DataView.prototype inherits Object.prototype and owns constructor, buffer, byteOffset, byteLength, and @@toStringTag properties. The accessors enforce DataView receivers, expose standard getter metadata, preserve access to the backing buffer after detachment, and reject byte-length and byte-offset access on detached buffers. |
