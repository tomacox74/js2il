...
> Last generated (UTC): 2026-09-01T05:29:59Z
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| DataView integer and floating-point getters/setters | Supported with Limitations | [`DataView_SetGet_UintAndEndian.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_SetGet_UintAndEndian.js)<br>[`DataView_Float32_Float64_RoundTrip.js`](../../../tests/Jroc.Tests/TypedArray/JavaScript/DataView_Float32_Float64_RoundTrip.js)<br>`tests/Jroc.Test262.Tests/built-ins/DataView/PortNext200Batch2ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/getInt8/DetachmentBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/getInt8/IntrinsicSurfaceExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/setInt8/DetachmentBatchExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/DataView/prototype/setInt8/IntrinsicSurfaceExecutionTests.cs` | `test/built-ins/DataView/prototype/getFloat32/toindex-byteoffset.js`<br>`test/built-ins/DataView/prototype/getFloat64/toindex-byteoffset.js`<br>`test/built-ins/DataView/prototype/getInt16/toindex-byteoffset.js`<br>`test/built-ins/DataView/prototype/getInt8/detached-buffer.js`<br>`test/built-ins/DataView/prototype/getInt8/length.js`<br>`test/built-ins/DataView/prototype/getInt8/name.js`<br>`test/built-ins/DataView/prototype/getInt8/not-a-constructor.js`<br>`test/built-ins/DataView/prototype/setInt8/detached-buffer-after-number-value.js`<br>`test/built-ins/DataView/prototype/setInt8/index-check-before-value-conversion.js`<br>`test/built-ins/DataView/prototype/setInt8/length.js`<br>`test/built-ins/DataView/prototype/setInt8/name.js`<br>`test/built-ins/DataView/prototype/setInt8/not-a-constructor.js` | Implements get/set for Int8, Uint8, Int16, Uint16, Int32, Uint32, Float32, and Float64 with optional littleEndian support (default big-endian). Each operation is exposed as a receiver-aware, non-constructible prototype method with standard name, length, and property attributes. Byte offsets use ToIndex coercion, including truncation of negative fractional values before range validation. Numeric accessors reject detached backing buffers after required argument coercions, and setters validate the offset before converting the value. BigInt64, BigUint64, and Float16 remain unimplemented. |
