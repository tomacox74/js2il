...
> Last generated (UTC): 2026-09-25T00:52:43Z

JROC exposes the Atomics global, its %Symbol.toStringTag%, integer typed-array atomic load, store, exchange, compare-exchange, arithmetic and bitwise operations, isLockFree, pause, and synchronous Atomics.wait for SharedArrayBuffer-backed Int32Array values. Atomics.notify and waitAsync are not exposed; full multi-agent memory-model conformance is not yet verified.
