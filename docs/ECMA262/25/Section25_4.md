...
| Worker-based Atomics.wait, waitAsync, and notify | Supported with Limitations | `tests/Jroc.Test262.Tests/built-ins/Atomics/notify/AtomicsAgent100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Atomics/notify/bigint/AtomicsAgent100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Atomics/wait/AtomicsAgent100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Atomics/wait/bigint/AtomicsAgent100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Atomics/waitAsync/AtomicsAgent100ExecutionTests.cs`<br>`tests/Jroc.Test262.Tests/built-ins/Atomics/waitAsync/bigint/AtomicsAgent100ExecutionTests.cs` | `test/built-ins/Atomics/notify/count-defaults-to-infinity-missing.js`<br>`test/built-ins/Atomics/notify/bigint/notify-all-on-loc.js`<br>`test/built-ins/Atomics/wait/false-for-timeout-agent.js`<br>`test/built-ins/Atomics/wait/bigint/false-for-timeout-agent.js`<br>`test/built-ins/Atomics/waitAsync/false-for-timeout-agent.js`<br>`test/built-ins/Atomics/waitAsync/bigint/false-for-timeout-agent.js` | 100 previously failing pinned tests exercise synchronized shared-buffer access, waiter ordering, notifications, and worker reports through the native Test262 agent host. This is not a claim of complete cross-agent memory-model conformance. |
