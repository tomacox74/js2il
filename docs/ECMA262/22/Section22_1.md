...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| String.prototype object | Supported with Limitations | [`String_Prototype_Iterator_Surface.js`](../../../tests/Jroc.Tests/String/JavaScript/String_Prototype_Iterator_Surface.js)<br>[`String_PrototypeMethodOverrides.js`](../../../tests/Jroc.Tests/String/JavaScript/String_PrototypeMethodOverrides.js)<br>[`S15.5.4_A1.js`](../../../tests/Jroc.Test262.Tests/built-ins/String/prototype/JavaScript/S15.5.4_A1.js)<br>[`S15.5.4_A2.js`](../../../tests/Jroc.Test262.Tests/built-ins/String/prototype/JavaScript/S15.5.4_A2.js)<br>[`S15.5.4_A3.js`](../../../tests/Jroc.Test262.Tests/built-ins/String/prototype/JavaScript/S15.5.4_A3.js) | `test/built-ins/String/prototype/S15.5.4_A1.js`<br>`test/built-ins/String/prototype/S15.5.4_A2.js`<br>`test/built-ins/String/prototype/S15.5.4_A3.js` | GlobalThis.String.prototype is exposed as a realm-owned runtime object with [[StringData]]="" behavior and String toStringTag metadata so legacy prototype-object checks align with the covered spec slice. Primitive string property reads and method calls observe its descriptors, mutations, and inherited properties; unguarded direct helper dispatch is intentionally not used. Full boxed-string exotic behavior remains limited. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| String.prototype.at | Supported with Limitations | [`String_NewApis_Basic.js`](../../../tests/Jroc.Tests/String/JavaScript/String_NewApis_Basic.js)<br>[`String_Prototype_Iterator_Surface.js`](../../../tests/Jroc.Tests/String/JavaScript/String_Prototype_Iterator_Surface.js)<br>`tests/Jroc.Test262.Tests/built-ins/String/prototype/at/ExecutionTests.cs` | suite `built_ins.String.prototype.at`<br>`test/built-ins/String/prototype/at/length.js`<br>`test/built-ins/String/prototype/at/name.js`<br>`test/built-ins/String/prototype/at/returns-item.js`<br>`test/built-ins/String/prototype/at/returns-item-relative-index.js` | Implemented in JavaScriptRuntime.String.At with negative-index support and exposed both through string fast paths and String.prototype. Out-of-range results surface as jroc's undefined/null representation rather than a boxed wrapper value. |

### 22.1.3.2 ([tc39.es](https://tc39.es/ecma262/#sec-string.prototype.charat))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| String.prototype.charAt | Supported with Limitations | [`String_CharAt_Basic.js`](../../../tests/Jroc.Tests/String/JavaScript/String_CharAt_Basic.js)<br>`tests/Jroc.Test262.Tests/built-ins/String/prototype/charAt/ExecutionTests.cs` | suite `built_ins.String.prototype.charAt`<br>`test/built-ins/String/prototype/charAt/name.js`<br>`test/built-ins/String/prototype/charAt/not-a-constructor.js`<br>`test/built-ins/String/prototype/charAt/pos-coerce-err.js`<br>`test/built-ins/String/prototype/charAt/S15.5.4.4_A10.js`<br>`test/built-ins/String/prototype/charAt/S15.5.4.4_A6.js`<br>`test/built-ins/String/prototype/charAt/S15.5.4.4_A7.js`<br>`test/built-ins/String/prototype/charAt/S15.5.4.4_A8.js`<br>`test/built-ins/String/prototype/charAt/S15.5.4.4_A9.js`<br>`test/built-ins/String/prototype/charAt/S9.4_A2.js`<br>`test/built-ins/String/prototype/charAt/this-value-not-obj-coercible.js` | Implemented via JavaScriptRuntime.String.CharAt and exposed on the shared String.prototype surface through ordinary property dispatch. Covered test262 cases exercise metadata, receiver validation, and abrupt position coercion. The upstream eval-dependent fixture remains unsupported, and boxed String wrapper semantics and full exotic-property observability remain limited. |

### 22.1.3.3 ([tc39.es](https://tc39.es/ecma262/#sec-string.prototype.charcodeat))

| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| String.prototype.charCodeAt | Supported with Limitations | [`String_CharCodeAt_Basic.js`](../../../tests/Jroc.Tests/String/JavaScript/String_CharCodeAt_Basic.js)<br>`tests/Jroc.Test262.Tests/built-ins/String/prototype/charCodeAt/ExecutionTests.cs` | suite `built_ins.String.prototype.charCodeAt`<br>`test/built-ins/String/prototype/charCodeAt/name.js`<br>`test/built-ins/String/prototype/charCodeAt/not-a-constructor.js`<br>`test/built-ins/String/prototype/charCodeAt/pos-coerce-err.js`<br>`test/built-ins/String/prototype/charCodeAt/S15.5.4.5_A10.js`<br>`test/built-ins/String/prototype/charCodeAt/S15.5.4.5_A6.js`<br>`test/built-ins/String/prototype/charCodeAt/S15.5.4.5_A7.js`<br>`test/built-ins/String/prototype/charCodeAt/S15.5.4.5_A8.js`<br>`test/built-ins/String/prototype/charCodeAt/S15.5.4.5_A9.js`<br>`test/built-ins/String/prototype/charCodeAt/this-value-not-obj-coercible.js` | Implemented in JavaScriptRuntime.String.CharCodeAt and exposed on the shared String.prototype surface. Covered test262 cases exercise metadata, receiver validation, and abrupt position coercion. The upstream eval-dependent fixture remains unsupported, and boxed String wrapper semantics remain limited. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| String.prototype.replaceAll | Supported with Limitations | [`String_NewApis_Basic.js`](../../../tests/Jroc.Tests/String/JavaScript/String_NewApis_Basic.js)<br>`tests/Jroc.Test262.Tests/built-ins/String/prototype/replaceAll/ExecutionTests.cs` | `test/built-ins/String/prototype/replaceAll/cstm-replaceall-on-bigint-primitive.js`<br>`test/built-ins/String/prototype/replaceAll/cstm-replaceall-on-boolean-primitive.js`<br>`test/built-ins/String/prototype/replaceAll/cstm-replaceall-on-number-primitive.js`<br>`test/built-ins/String/prototype/replaceAll/cstm-replaceall-on-string-primitive.js`<br>`test/built-ins/String/prototype/replaceAll/replaceValue-call-abrupt.js`<br>`test/built-ins/String/prototype/replaceAll/replaceValue-call-each-match-position.js`<br>`test/built-ins/String/prototype/replaceAll/replaceValue-call-matching-empty.js`<br>`test/built-ins/String/prototype/replaceAll/replaceValue-call-tostring-abrupt.js`<br>`test/built-ins/String/prototype/replaceAll/replaceValue-fn-skip-toString.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-flags-no-g-throws.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-flags-null-undefined-throws.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-flags-toString-abrupt.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-get-flags-abrupt.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-isRegExp-abrupt.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-replacer-before-tostring.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-replacer-call-abrupt.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-replacer-call.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-replacer-is-null.js`<br>`test/built-ins/String/prototype/replaceAll/searchValue-replacer-method-abrupt.js` | Implemented for literal-string search values, callable and string replacements, global RegExp inputs, and object @@replace dispatch. RegExp detection and global-flag validation precede receiver and replacement coercion; callable replacements receive each match, position, and input, and abrupt completions propagate. Primitive search values do not observe prototype @@replace hooks. Named-capture $<name> substitutions remain unsupported. |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| String.prototype.toUpperCase | Supported with Limitations | [`String_ToLowerCase_ToUpperCase_Basic.js`](../../../tests/Jroc.Tests/String/JavaScript/String_ToLowerCase_ToUpperCase_Basic.js) | suite `built_ins.String.prototype.toUpperCase`<br>`test/built-ins/String/prototype/toUpperCase/special_casing.js` | Implemented in JavaScriptRuntime.String.ToUpperCase for definite string receivers, including Unicode 16.0 full-uppercase special-casing mappings and multi-code-point expansions. |
