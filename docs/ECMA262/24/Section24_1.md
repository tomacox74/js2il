...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| Map.prototype[@@iterator] | Supported | [`Map_Symbol_Iterator.js`](../../../tests/Js2IL.Tests/Map/JavaScript/Map_Symbol_Iterator.js) |  | Map instances now expose a Symbol.iterator method that returns the same entry iterator shape as entries(). |
...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| %MapIteratorPrototype%[@@toStringTag] | Not Yet Supported | [`Map_Keys_Values_Entries.js`](../../../tests/Js2IL.Tests/Map/JavaScript/Map_Keys_Values_Entries.js)<br>[`Map_Symbol_Iterator.js`](../../../tests/Js2IL.Tests/Map/JavaScript/Map_Symbol_Iterator.js) |  | Map iterators currently implement the runtime next()/return() protocol used by entries(), keys(), values(), and @@iterator, but JS2IL does not yet install the spec %MapIteratorPrototype% Symbol.toStringTag metadata. |
