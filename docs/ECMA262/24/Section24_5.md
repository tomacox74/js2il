...
|---|---|---|---|
| CanonicalizeKeyedCollectionKey behavior | Incomplete | [`Map_Null_Key.js`](../../../tests/Jroc.Tests/Map/JavaScript/Map_Null_Key.js) | Map uses a null sentinel plus a SameValueZero-style comparer to support common key cases such as null and NaN, but JROC does not implement a shared CanonicalizeKeyedCollectionKey abstraction across Map, Set, WeakMap, and WeakSet, and full canonical storage behavior such as normalizing -0 to +0 in observable results remains incomplete. |
