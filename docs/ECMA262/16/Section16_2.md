...
|---|---|---|---|
| full module record/linking/evaluation model | Not Yet Supported |  | Current implementation parses module source with `ParseScript` plus a rewrite pass; it does not model ECMA-262 module records, host hooks, or spec-accurate link/evaluate algorithms. |
