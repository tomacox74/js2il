...
| Array literal spread (copy elements) | Supported | [`Array_Spread_Copy.js`](../../../Js2IL.Tests/Literals/JavaScript/Array_Spread_Copy.js) | Spread elements in array literals are emitted via JavaScriptRuntime.Array.PushRange; supports copying from another array. |
...
| Object literal spread properties ({ ...x }) | Supported | [`ObjectLiteral_Spread_Basic.js`](../../../Js2IL.Tests/Object/JavaScript/ObjectLiteral_Spread_Basic.js) | Lowered as: create empty ExpandoObject, then apply members in order. Spread members call JavaScriptRuntime.Object.SpreadInto(target, source). Null/undefined sources are ignored. |
