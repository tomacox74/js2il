...
| NewExpression for user-defined classes (new Ctor(...)) | Supported | [`Classes_DeclareEmptyClass.js`](../../../tests/Jroc.Tests/Classes/JavaScript/Classes_DeclareEmptyClass.js)<br>[`Classes_ClassConstructor_WithMultipleParameters.js`](../../../tests/Jroc.Tests/Classes/JavaScript/Classes_ClassConstructor_WithMultipleParameters.js)<br>[`Function_GeneratedConstruction_Semantics.js`](../../../tests/Jroc.Tests/Function/JavaScript/Function_GeneratedConstruction_Semantics.js) |  | User-defined classes are lowered to direct CLR construction of the generated type, including scope-array wiring for closures in constructors/methods. Derived classes with function-valued bases preserve replacement-object returns and propagate the derived constructor as new.target. Spread arguments in `new` are not supported. |
...
| super(...) calls base constructor in derived constructors | Supported | [`Classes_Inheritance_SuperConstructor_Args.js`](../../../tests/Jroc.Tests/Classes/JavaScript/Classes_Inheritance_SuperConstructor_Args.js) |  | Supported for derived class constructors. |
