...
| Feature name | Status | Test scripts | test262 evidence | Notes |
|---|---|---|---|---|
| lexical super in arrow functions | Supported | [`lexical-super-property.js`](../../../tests/Jroc.Test262.Tests/language/expressions/arrow-function/JavaScript/lexical-super-property.js)<br>[`lexical-super-property-from-within-constructor.js`](../../../tests/Jroc.Test262.Tests/language/expressions/arrow-function/JavaScript/lexical-super-property-from-within-constructor.js)<br>[`lexical-supercall-from-immediately-invoked-arrow.js`](../../../tests/Jroc.Test262.Tests/language/expressions/arrow-function/JavaScript/lexical-supercall-from-immediately-invoked-arrow.js)<br>[`lexical-super-call-from-within-constructor.js`](../../../tests/Jroc.Test262.Tests/language/expressions/arrow-function/JavaScript/lexical-super-call-from-within-constructor.js) | `test/language/expressions/arrow-function/lexical-super-property.js`<br>`test/language/expressions/arrow-function/lexical-super-property-from-within-constructor.js`<br>`test/language/expressions/arrow-function/lexical-supercall-from-immediately-invoked-arrow.js`<br>`test/language/expressions/arrow-function/lexical-super-call-from-within-constructor.js` | Arrow functions inherit super bindings from enclosing class methods and derived constructors. This includes base property calls, immediately invoked super constructor calls, and the required ReferenceError when a retained arrow calls super() after the derived this binding has already been initialized (GitHub issue #1498). |
