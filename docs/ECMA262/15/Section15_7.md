...
JS2IL supports class declarations/expressions, methods (including async and generator methods), identifier-named instance/static accessors, constructors (including derived constructors with super calls), and public/private instance/static fields with initializers. Limitations: class static blocks are not supported; computed method/field names and private methods/accessors are rejected.
...
| Identifier-named class instance/static accessors (get x() / set x(v)) | Supported with Limitations | [`Classes_AccessorMethods_InstanceAndStatic.js`](../../../Js2IL.Tests/Classes/JavaScript/Classes_AccessorMethods_InstanceAndStatic.js) | Identifier-named instance and static accessors compile and dispatch correctly for normal property reads/writes, including accessor this binding and static access through the class object. Computed class accessors, private accessors, and static blocks remain unsupported. |
...
| Private methods (#m() {}) | Not Yet Supported | `Js2IL.Tests/ValidatorTests.cs` | Validator rejects private methods and private accessors; JS2IL currently supports private fields, but not private methods/accessors. |
