...
| Object literal method definition (shorthand method) | Supported | [`ObjectLiteral_ShorthandAndMethod.js`](../../../tests/Jroc.Tests/Object/JavaScript/ObjectLiteral_ShorthandAndMethod.js)<br>[`ObjectLiteral_GeneratedMethodFunctionObjects.js`](../../../tests/Jroc.Tests/Object/JavaScript/ObjectLiteral_GeneratedMethodFunctionObjects.js)<br>[`Function_ObjectLiteralMethod_ThisBinding.js`](../../../tests/Jroc.Tests/Function/JavaScript/Function_ObjectLiteralMethod_ThisBinding.js)<br>`tests/Jroc.Test262.Tests/language/expressions/object/method-definition/ObjectMethodDefinitionConformance11BatchTests.cs` | suite `language.expressions.object_.method_definition`<br>`test/language/expressions/object/method-definition/generator-length.js`<br>`test/language/expressions/object/method-definition/meth-dflt-params-ref-prior.js`<br>`test/language/expressions/object/method-definition/private-name-early-error-method.js` | Synchronous object-literal methods materialize as generated JsFunctionObject instances with correct member/extracted receiver behavior, computed names, home-object super state, non-constructability, and distinct identity for each object evaluation. The native Test262 harness now verifies 93 additional current-provenance object method-definition fixtures covering generator metadata, parameter binding, strict-mode and private-name early errors. |
