...
- events module implements the full core EventEmitter listener lifecycle APIs; advanced features such as errorMonitor, captureRejections, newListener/removeListener events, and async iterator helpers are not yet implemented.
