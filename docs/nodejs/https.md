...
**Tests:**
- `Jroc.Tests.Node.Https.ExecutionTests.Https_Get_Loopback_SelfSigned` (`tests/Jroc.Tests/Node/Https/ExecutionTests.cs`)
- `Jroc.Tests.Node.Https.ExecutionTests.Https_Request_Post_Basic` (`tests/Jroc.Tests/Node/Https/ExecutionTests.cs`)
- `Jroc.Tests.Node.Https.GeneratorTests.Https_Get_Loopback_SelfSigned` (`tests/Jroc.Tests/Node/Https/GeneratorTests.cs`)
- `Jroc.Tests.Node.Https.GeneratorTests.Https_Request_Post_Basic` (`tests/Jroc.Tests/Node/Https/GeneratorTests.cs`)
...
- `Jroc.Tests.Node.Https.ExecutionTests.Https_Request_Post_Basic` (`tests/Jroc.Tests/Node/Https/ExecutionTests.cs`)
- `Jroc.Tests.Node.Https.GeneratorTests.Https_Request_Post_Basic` (`tests/Jroc.Tests/Node/Https/GeneratorTests.cs`)
- `Jroc.Tests.Node.Https.ExecutionTests.Https_Request_UrlObject_WithOptions` (`tests/Jroc.Tests/Node/Https/ExecutionTests.cs`)
- `Jroc.Tests.Node.Https.GeneratorTests.Https_Request_UrlObject_WithOptions` (`tests/Jroc.Tests/Node/Https/GeneratorTests.cs`)
