...
**Tests:**
- `Jroc.Tests.Node.Net.ExecutionTests.Net_CreateServer_Connect_Basic` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_CreateServer_Connect_Basic` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
- `Jroc.Tests.Node.Net.ExecutionTests.Net_CreateServer_AllowHalfOpen_Delayed_Response` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_CreateServer_AllowHalfOpen_Delayed_Response` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
...
- `Jroc.Tests.Node.Net.ExecutionTests.Net_CreateServer_Connect_Basic` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_CreateServer_Connect_Basic` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
- `Jroc.Tests.Node.Net.ExecutionTests.Net_Socket_Binary_Data_Defaults_To_Buffer` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_Socket_Binary_Data_Defaults_To_Buffer` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
- `Jroc.Tests.Node.Net.ExecutionTests.Net_Socket_SetEncoding_Utf8` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_Socket_SetEncoding_Utf8` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
...
- `Jroc.Tests.Node.Net.ExecutionTests.Net_Socket_SetEncoding_Utf8` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_Socket_SetEncoding_Utf8` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
- `Jroc.Tests.Node.Net.ExecutionTests.Net_Socket_Timeout_Allows_Graceful_End` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_Socket_Timeout_Allows_Graceful_End` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
- `Jroc.Tests.Node.Net.ExecutionTests.Net_CreateServer_AllowHalfOpen_Delayed_Response` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_CreateServer_AllowHalfOpen_Delayed_Response` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
- `Jroc.Tests.Node.Net.ExecutionTests.Net_Socket_KeepAlive_And_Unsupported_Options` (`tests/Jroc.Tests/Node/Net/ExecutionTests.cs`)
- `Jroc.Tests.Node.Net.GeneratorTests.Net_Socket_KeepAlive_And_Unsupported_Options` (`tests/Jroc.Tests/Node/Net/GeneratorTests.cs`)
