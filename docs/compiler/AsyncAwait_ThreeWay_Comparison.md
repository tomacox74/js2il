...
- Async lowering spec: [docs/compiler/AsyncAwait_LoweringSpec.md](AsyncAwait_LoweringSpec.md)
- Try/catch strategy: [docs/compiler/CapturedVariables_ScopesABI.md](CapturedVariables_ScopesABI.md)
