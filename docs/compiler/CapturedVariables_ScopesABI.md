...
- This is a good direction because `Closure` and `ExportMemberResolver` currently infer ABI from a leading `object[]` parameter, which is brittle for long-term evolution.
