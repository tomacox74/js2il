...
- `host/` – a C# console app that restores `Jroc.SDK` and `Jroc.Runtime`, compiles the JavaScript input via `JrocCompile`, and calls into the resulting module assembly using generated `Run`/`Import` facades.
