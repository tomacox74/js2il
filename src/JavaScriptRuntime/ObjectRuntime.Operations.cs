...
namespace JavaScriptRuntime
{
    public static partial class ObjectRuntime
    {
        ...
        internal static object ToExternalPropertyKey(string key)
        ...
        internal static List<string> GetOwnPropertyKeysInOrder(
            ...
            => GetOrderedOwnKeys(obj, includeEncodedSymbolKeys);
        ...
        /// <summary>
        /// Generic member-call dispatcher.
        /// </summary>
        public static object? CallMember(object receiver, string methodName, object[]? args)
        {
            ...
            {
                var stringMember = GetProperty(receiver, methodName);
                if (CallableOperations.IsCallable(stringMember))
                {
                    return InvokeCallableMember(receiver, stringMember!, callArgs);
                }
        ...
        private static bool HasOwnPropertyForPropertyLookup(object target, string name)
        {
            ...
            if (target is TypedArrayBase typedArray)
            {
                ...
                return ObjectRuntime.TryParseCanonicalIndexString(name, out var index) && index >= 0 && index < typedArray.length;
            }
            ...
            if (target is string str)
            {
                ...
                return ObjectRuntime.TryParseCanonicalIndexString(name, out var index) && index >= 0 && index < str.Length;
            }
        ...
        public static bool IteratorResultDone(object iteratorResult)
        {
            ...
            var doneObj = ObjectRuntime.GetItem(iteratorResult, "done");
        ...
        public static object? SetProperty(object obj, string name, object? value, bool throwOnError)
        {
            ...
            if (PropertyDescriptorStore.TryGetOwn(obj, name, out var desc))
            {
                ...
                desc = PropertyDescriptorStore.CloneDescriptor(desc);
                desc.Value = value;
                if (obj is JsObject descriptorObject)
                {
