...
public sealed partial class HIRToLIRLowerer
{
    ...
    private static bool IsImmutableFunctionExpressionNameBinding(BindingInfo binding)
        => binding.Kind == BindingKind.Function
           && binding.Callable?.Semantics.IsNamedFunctionExpression == true
           && string.Equals(binding.Callable.Name, binding.Name, StringComparison.Ordinal);

    private bool DoesClassNeedParentScopes(Scope classScope)
        => classScope.ClassSemantics?.RequiresParentScopes
