...
namespace Js2IL.Services
{
    ...
    internal class Variables
    {
        ...
        /// <param name="parameterNames">Optional parameter names for the global scope (e.g., module parameters).</param>
        public Variables(VariableBindings.VariableRegistry registry, string scopeName, IEnumerable<string>? parameterNames = null)
        {
            ...
            // Build parameter map if parameters are provided
            // For global/main scope, parameters start at arg0 (no scopes array prefix)
