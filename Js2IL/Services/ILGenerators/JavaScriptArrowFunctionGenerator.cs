...
namespace Js2IL.Services.ILGenerators
{
    internal sealed class JavaScriptArrowFunctionGenerator
    {
            ...
            string[] paramNames)
        {
            ...
            if (_twoPhaseCoordinator.Registry.TryGetDeclaredTokenForAstNode(arrowFunction, out var existingToken) &&
            ...
            if (_symbolTable != null)
            {
                ...
                if (arrowScope != null)
                {
                    ...
                    if (!compiledMethod.IsNil)
                    {
                        ...
                        _twoPhaseCoordinator.Registry.SetDeclaredTokenForAstNode(arrowFunction, (EntityHandle)compiledMethod);
            ...
            // Two-phase: register the token in the canonical CallableRegistry
            _twoPhaseCoordinator.Registry.SetDeclaredTokenForAstNode(arrowFunction, (EntityHandle)mdh);
