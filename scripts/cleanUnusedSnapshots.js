 ...
 * is not referenced in any test source (*.cs) under the supplied root (default: tests/Jroc.Tests).
 */
const fs = require('fs');
const path = require('path');

function usage() {
  console.log(`Usage: node scripts/cleanUnusedSnapshots.js [--root tests/Jroc.Tests] [--delete] [--quiet]`);
}

function parseArgs(argv) {
  const args = { root: 'tests/Jroc.Tests', delete: false, quiet: false };
